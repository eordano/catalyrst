...
7. Add the crate to `CATALYRST_CRATES` and `OPENAPI_CRATES` in
   `sites/scripts/ts-crates.sh`, run `npm run gen:types` in sites, and commit the
   regenerated `ui3/src/generated/catalyst/openapi/` files.
