...
/// Full external-URI closure of a glTF/glb source (images AND buffers) —
/// the byte-affecting input set the S1 variant-keyed dedup digests; the
/// image-only list under-keys shared .gltf bundles.
