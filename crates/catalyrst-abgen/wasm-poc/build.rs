// On wasm32 the vendored C/C++ codecs (libjpeg9c, crnlib, draco) are
// compiled against the wasi-libc sysroot, so the final cdylib link needs
// libc/libc++ static archives. Paths come from the nix devShell
// (wasm-poc/toolchain/flake.nix).
fn main() {
