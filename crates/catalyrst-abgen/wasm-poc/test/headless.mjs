...
let lod = 1, crop = 0, triCap = 0;
const positional = [];
for (const a of process.argv.slice(2)) {
  if (a.startsWith('--lod=')) lod = a.slice(6) === '0' ? 0 : 1;
  else if (a.startsWith('--crop=')) crop = a.slice(7) === '1' ? 1 : 0;
  else if (a.startsWith('--tri-cap=')) triCap = parseInt(a.slice(10), 10) >>> 0;
...
parts.push(u32(pb.length), pb, u32(eb.length), eb,
  new Uint8Array([1, lod, 0, crop]), u32(triCap), u32(0), u32(0), u32(0));
let total = 0;
