...
#include <stdio.h>
#ifdef __wasm__
// wasm has no setjmp; this decoder is only reached via crnlib's file
// loaders, which abgen never calls — trap instead of recovering.
typedef int jmp_buf[1];
#define setjmp(env) 0
#define longjmp(env, v) __builtin_trap()
#else
#include <setjmp.h>
#endif
