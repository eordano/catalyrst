...
use catalyrst_communities::handlers::client;
use catalyrst_communities::handlers::writes;
...
async fn signed_headers(wallet: &LocalWallet, method: &str, path: &str) -> HeaderMap {
