...
pub fn api_router() -> Router<AppState> {
    Router::new()
        .route("/v1/communities", get(handlers::communities::get_communities).post(handlers::writes::create_community))
        .route(
            "/v1/mutes",
        ...
        .route(
            ...
            get(handlers::members::get_member_communities).post(handlers::writes::member_communities_by_ids),
        )
        .route(
