...
impl RequestsComponent {
    ...
    pub async fn list_by_community(
        ...
        let mut q = sqlx::query_as::<_, (Uuid, Uuid, String, String, String, NaiveDateTime, NaiveDateTime)>(&select_sql)
            .bind(community_id);
    ...
    pub async fn list_aggregated_by_member(
        ...
        let mut q = sqlx::query_as::<
            _,
            (Uuid, Uuid, String, String, String, String, String, String, bool, bool, i64, bool),
        >(&select_sql)
        .bind(&lower);
        ...
        let out = rows
            .into_iter()
            .map(
                |(id, community_id, member_address, status, kind, name, description, owner_address, private, active, members_count, has_thumbnail)| {
