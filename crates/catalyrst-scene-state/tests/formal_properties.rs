...
// ===========================================================================
// value_order_is_strict_total
// Coq: Core.vlt_irrefl, Core.vlt_trans, Core.vlt_trichotomy,
//      Core.bottom_below_empty
...
// ===========================================================================
// lww_cell_idempotent_and_join
// Coq: Core.lww_cell_idempotent, Core.B_step_is_join,
//      Core.tv_max_{comm,assoc,idem}
// ===========================================================================
...
// ===========================================================================
// lww_only_fragment_equivalence  (the order-independence half)
// Coq: Core.lww_fragment_order_independent
...
proptest! {
    ...
    fn lww_fragment_is_order_independent(
        ...
        // derive a permutation of `ops` from `perm` by repeated selection
...
// ===========================================================================
// network_message_types_agree  (the B half)
// Coq: Wire.network_types_dropped_by_both, Wire.network_type5_skipped_identically
