...
// Coq: Core.is_append_order_dependent   (weakenings: Core.lww_cell_commutative,
//      Core.lww_cell_commutative_A, Core.is_append_tv_still_agrees)
...
// Coq: Engine.append_B_keeps_one / append_A_keeps_both / append_second_not_relayed
...
// Coq: Engine.tomb_order1_resurrects / tomb_order2_stays_dead /
//      tomb_cap_breaks_convergence / tomb_delete_relayed_twice
...
// ===========================================================================
// D5  component cap
// Coq: Engine.cap_order1 / cap_order2
...
// Coq: Engine.snapshot_omits_component_tombstone / snapshot_not_state_determining
//      / snapshot_loses_entity_tombstone / snapshot_replays_append_event
...
// Coq: Engine.client_range_rejects_every_recycled_entity  (proved for ALL
//      ranges with start+size <= 2^16 and ALL generations >= 1)
//      Engine.client_range_accepts_generation_zero
...
// Coq: Engine.mask_B_applies / mask_A_drops / entity_mask_disagrees_generally
...
// Coq: Wire.framing_zerolen_B  (the B half of framing_zerolen_diverges)
...
// ===========================================================================
// Regression pins added with the fixes
// ===========================================================================
