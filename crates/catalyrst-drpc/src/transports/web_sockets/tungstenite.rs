...
impl From<Message> for TungsteniteMessage {
    fn from(value: Message) -> Self {
        match value {
            ...
            Message::Ping => TungsteniteMessage::Ping(Default::default()),
            Message::Pong => TungsteniteMessage::Pong(Default::default()),
...
impl From<TungsteniteMessage> for Message {
    fn from(value: TungsteniteMessage) -> Self {
        match value {
            TungsteniteMessage::Text(data) => Message::Text(data.to_string()),
