...
use crate::clients::{CommsGatekeeper, Places};
...
pub async fn build_state(cfg: &Config) -> Result<AppState> {
    ...
    let state = Arc::new(AppStateInner {
        ...
        places: Places::new(cfg.places_api_url.clone()),
    });
...
pub fn api_router_with_spec() -> (Router<AppState>, utoipa::openapi::OpenApi) {
    OpenApiRouter::with_openapi(ApiDoc::openapi())
        ...
        .routes(routes!(handlers::v1::get_v1_event_list))
        .routes(routes!(handlers::v1::get_v1_event))
        .routes(routes!(handlers::v1::get_v1_destination_events))
        .split_for_parts()
}
