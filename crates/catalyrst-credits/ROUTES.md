...
Host root, no path prefix. Listens on the deployment's assigned port (`5146`;
see `umbrella/env/catalyrst-credits.env`).
...
Spec: admin-console design §4, catalyrst-credits row (design doc recoverable at
git ref `ff400cab^:catalyrst/docs/admin-console.md`; operational doc:
`docs/operations/admin-console.md`). Every route below is
