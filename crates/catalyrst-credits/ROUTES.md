...
Listens on the deployment's assigned port (`5146`; see `umbrella/env/catalyrst-credits.env`).
...
doc: `docs/operations/admin-console.md`). Each route is gated by a constant-time bearer compare against
