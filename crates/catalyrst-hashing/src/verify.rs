...
fn is_canonical_cid(s: &str) -> bool {
...
mod tests {
    ...
    fn verify_cidv0_match() {
        assert!(verify_hash(b"hello world", "QmaozNR7DZHQK1ZcU9p7QdrshMvXqWK6gpu5rmrkPdT3L4"));
    }

    #[test]
    fn verify_cidv0_mismatch() {
        assert!(!verify_hash(b"hello world", "QmaozNR7DZHQK1ZcU9p7QdrshMvXqWK6gpu5rmrkPdAAAA"));
    }
