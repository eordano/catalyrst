...
async fn mirrored_worlds_serve_the_upstream_shape() {
    ...
    // A world is reachable by its name, case-insensitively.
...
async fn sweep_deletes_unseen_worlds_but_spares_locals_and_places() {
    ...
    // The first fixture world was last seen before the cutoff; the rest are
    // refreshed after it.
...
async fn sweep_fuse_refuses_mass_deletion_but_allows_small_sweeps() {
    ...
    // 100 mirrored worlds: the 5 fixture rows plus 95 synthetic ones.
