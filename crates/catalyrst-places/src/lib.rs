...
pub async fn build_state(cfg: &Config) -> Result<AppState> {
    ...
    if let Some(writer_url) = &cfg.places_writer_database_url {
        ...
        tracing::info!("no writer connection configured; favorites/likes/report persistence disabled (503)");
    }
    ...
    tracing::info!(gossip_live = gossip.is_live(), "places gossip publisher ready");
