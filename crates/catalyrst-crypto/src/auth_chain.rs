...
pub fn parse_ephemeral_payload(
    payload: &str,
) -> Result<(String, String, i64), crate::AuthError> {
...
mod tests {
    ...
    fn test_is_valid_eth_address() {
        assert!(is_valid_eth_address("0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266"));
        assert!(is_valid_eth_address("0x0000000000000000000000000000000000000000"));
        assert!(!is_valid_eth_address("f39Fd6e51aad88F6F4ce6aB8827279cffFb92266"));
        assert!(!is_valid_eth_address("0x1234"));
        assert!(!is_valid_eth_address("0xf39Fd6e51aad88F6F4ce6aB8827279cffFb922660"));
        assert!(!is_valid_eth_address("0xZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ"));
    }
