...
--
-- Historically these tables were created out-of-band by an earlier standalone
-- archiver schema (mana-price-archive-schema.sql) and this crate only ever read
...
--
-- IF NOT EXISTS everywhere so this is a no-op when that earlier schema (or a
