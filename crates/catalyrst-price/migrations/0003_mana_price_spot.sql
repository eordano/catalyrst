...
--
-- Historically these tables were created out-of-band by the reference deployment
...
--
-- IF NOT EXISTS everywhere so this is a no-op when the reference schema (or a
