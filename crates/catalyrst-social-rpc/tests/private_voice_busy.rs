...
use catalyrst_social_rpc::proto::v2::{
    start_private_voice_chat_response, SocialServiceServer, StartPrivateVoiceChatPayload, User,
};
use catalyrst_social_rpc::service::{SocialError, SocialServiceImpl};
use catalyrst_social_rpc::Context;
...
async fn start_call(
    ...
    me: &str,
    callee: &str,
) -> Result<catalyrst_social_rpc::proto::v2::StartPrivateVoiceChatResponse, SocialError> {
