...
impl EnvironmentConfig {
    pub fn from_env() -> Self {
        ...
        let http_server_port: u16 =
            env_or("HTTP_SERVER_PORT", &DEFAULT_HTTP_SERVER_PORT.to_string())
                .parse()
        ...
        Self {
            ...
            content_server_address: std::env::var("CONTENT_SERVER_ADDRESS")
                .unwrap_or_else(|_| format!("http://127.0.0.1:{}", http_server_port)),
            ...
            entities_cache_size: env_or(
                "ENTITIES_CACHE_SIZE",
                &DEFAULT_ENTITIES_CACHE_SIZE.to_string(),
            )
            .parse()
