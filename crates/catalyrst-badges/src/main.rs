...
const ENV_DOCS: &[(&str, &str)] = &[
    ...
    (
        "BADGES_ASSETS_DIR",
        "optional — directory served at /assets (default ./assets); missing files 404, missing dir doesn't crash startup",
    ),
    (
        "BADGES_PUBLIC_ASSET_BASE_URL",
        "optional — host+scheme substituted for https://badges.decentraland.org in every assets URL at serve time (default: unchanged, keeps upstream parity)",
    ),
    (
        "RUST_LOG",
