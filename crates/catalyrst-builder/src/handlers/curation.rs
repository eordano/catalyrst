...
mod tests {
    ...
    #[tokio::test]
    async fn admin_auth_probe_unset_configured_token_rejects() {
        assert!(authorize_admin(
            None,
            NO_ADMINS,
    ...
    #[tokio::test]
    async fn admin_auth_probe_empty_configured_token_must_reject() {
        assert!(authorize_admin(
            Some(""),
            NO_ADMINS,
    ...
    #[tokio::test]
    async fn admin_auth_probe_empty_presented_vs_set_secret_rejects() {
        assert!(authorize_admin(
            Some("the-real-token"),
            NO_ADMINS,
            &headers_with(Some("Bearer ")),
        ...
        assert!(authorize_admin(
            Some("the-real-token"),
            NO_ADMINS,
            &headers_with(Some("Bearer the-real-token")),
            "get",
            "/x"
        )
        .await
