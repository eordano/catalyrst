// DB-gated pins for the favorites lane semantics fixed in the cbf12ff /
// shop-c0cc5df parity fix round:
//
...
//
// Plus the 2026-08 parity follow-ups:
//
...
async fn shared_default_wishlist_is_surfaced_first_and_caller_scoped() {
    ...
    // Both wallets pick into the shared Wishlist (the shop c0cc5df flow).
