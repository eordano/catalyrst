...
fn unified_min_credit_filter_is_ceil_consistent() {
    // CEIL(x / C) >= 3 <=> x > 2C: a legacy item whose usd_wei sits just above 2C displays as 3
    // credits and must pass a minPriceCredits=3 filter even though its usd_wei < 3C.
