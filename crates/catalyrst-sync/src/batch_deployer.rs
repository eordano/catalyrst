...
use crate::{
    ContentStorage, Deployer, DeploymentContext, DeploymentRepository, FailedDeployment,
    FailedDeploymentsStore, FailureReason, SyncDeployment, SyncError, TimeRange,
};
...
impl DeploymentScheduler for BatchDeployer {
    ...
    async fn prepare_for_deployments_in(
        &self,
