...
pub fn parse_range_header(range_header: Option<&str>, total_size: Option<u64>) -> Option<ParsedRange> {
...
pub fn content_file_headers(hash: &str, size: Option<u64>, encoding: Option<&str>) -> Vec<(&'static str, String)> {
    let mut headers = vec![
...
pub fn mask_entity(entity: &serde_json::Value, fields: Option<&[EntityField]>) -> serde_json::Value {
