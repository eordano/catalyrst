...
pub fn build_router(state: Arc<AppState>) -> Router {
    ...
    let top: Router<Arc<AppState>> = Router::new()
        ...
        .route("/admin/api/content/flush-cache", post(admin::api::flush_deployments_cache))
        // Content-local mutations (WO-3 / LATER tranche). Each writes to the
        // shared `admin_audit` log keyed by the authenticated address.
        .route("/admin/api/content/failed-deployments/retry", post(admin::api::content_retry_failed))
        .route("/admin/api/content/failed-deployments/clear", post(admin::api::content_clear_failed))
        .route("/admin/api/content/denylist/add", post(admin::api::content_denylist_add))
        .route("/admin/api/content/denylist/remove", post(admin::api::content_denylist_remove))
        .route("/admin/api/content/denylist/list", post(admin::api::content_denylist_list))
        .route("/admin/api/content/snapshots/regenerate", post(admin::api::content_snapshots_regenerate))
        .route("/admin/api/content/challenge/refresh", post(admin::api::content_challenge_refresh))
        .route("/admin/api/content/sync/pause", post(admin::api::content_sync_pause))
        .route("/admin/api/content/sync/resume", post(admin::api::content_sync_resume))
        .route("/admin/api/content/sync/force", post(admin::api::content_sync_force))
        .route("/admin/api/content/read-only", post(admin::api::content_read_only))
        .route("/admin/api/content/accepting-users", post(admin::api::content_accepting_users))
        .route("/admin/api/telemetry/issue-state", post(admin::api::telemetry_issue_state))
        .route("/admin/api/telemetry/sql", post(admin::api::telemetry_sql))
        .route("/admin/api/create/registry-reingest", post(admin::api::create_registry_reingest))
        .route("/admin/api/create/flush-ab-cache", post(admin::api::create_flush_ab_cache))
        .route("/admin/api/social/user-ban", post(admin::api::social_user_ban))
        .route("/admin/api/social/user-unban", post(admin::api::social_user_unban))
        .route("/admin/api/social/user-warning", post(admin::api::social_user_warning))
        ...
        .route("/admin/api/places/reports", post(admin::api::places_reports_list))
        .route("/admin/api/places/report-resolve", post(admin::api::places_report_resolve))
        .route("/admin/api/places/place-disable", post(admin::api::places_place_disable))
        .route("/admin/api/places/pois-list", post(admin::api::places_pois_list))
        .route("/admin/api/places/poi-create", post(admin::api::places_poi_create))
        .route("/admin/api/places/poi-update", post(admin::api::places_poi_update))
        .route("/admin/api/places/poi-delete", post(admin::api::places_poi_delete))
        .route("/admin/api/places/place-highlight", post(admin::api::places_place_highlight))
        .route("/admin/api/places/place-rating", post(admin::api::places_place_rating))
        .route("/admin/api/places/world-highlight", post(admin::api::places_world_highlight))
        .route("/admin/api/places/world-rating", post(admin::api::places_world_rating))
        // events (bundle: explore)
        .route("/admin/api/events/create", post(admin::api::events_create))
        .route("/admin/api/events/moderate", post(admin::api::events_moderate))
        ...
        .route("/admin/api/worlds/disable", post(admin::api::worlds_disable))
        .route("/admin/api/worlds/ban-status", post(admin::api::worlds_ban_status))
        .route("/admin/api/worlds/blocked-list", post(admin::api::worlds_blocked_list))
        .route("/admin/api/worlds/blocked-add", post(admin::api::worlds_blocked_add))
        .route("/admin/api/worlds/blocked-remove", post(admin::api::worlds_blocked_remove))
        .route("/admin/api/worlds/access-log", post(admin::api::worlds_access_log))
        // ab-registry (bundle: create)
        .route("/admin/api/create/queues-retry", post(admin::api::create_queues_retry))
        .route("/admin/api/create/queues-pause", post(admin::api::create_queues_pause))
        .route("/admin/api/create/queues-resume", post(admin::api::create_queues_resume))
        .route("/admin/api/create/queues-status", post(admin::api::create_queues_status))
        .route("/admin/api/create/denylist-add", post(admin::api::create_denylist_add))
        .route("/admin/api/create/denylist-remove", post(admin::api::create_denylist_remove))
        // camera-reel (bundle: create)
        .route("/admin/api/camera-reel/image-delete", post(admin::api::camera_reel_image_delete))
        .route("/admin/api/camera-reel/image-review", post(admin::api::camera_reel_image_review))
        // builder (bundle: create)
        .route("/admin/api/builder/item-status", post(admin::api::builder_item_status))
        .route("/admin/api/builder/items-status", post(admin::api::builder_items_status_bulk))
        // communities (bundle: social)
        .route("/admin/api/communities/list", post(admin::api::communities_list))
        .route("/admin/api/communities/suspend", post(admin::api::communities_suspend))
        .route("/admin/api/communities/unsuspend", post(admin::api::communities_unsuspend))
        // notifications (bundle: social)
        .route("/admin/api/notifications/broadcast", post(admin::api::notifications_broadcast))
        ...
        .route("/admin/api/social-rpc/presence", post(admin::api::social_rpc_presence))
        .route("/admin/api/social-rpc/voice-calls", post(admin::api::social_rpc_voice_calls))
        .route("/admin/api/social-rpc/friendships", post(admin::api::social_rpc_friendships))
        .route("/admin/api/social-rpc/disconnect", post(admin::api::social_rpc_disconnect))
        .route("/admin/api/social-rpc/force-presence", post(admin::api::social_rpc_force_presence))
        .route("/admin/api/social-rpc/reset-settings", post(admin::api::social_rpc_reset_settings))
        // scene-state (bundle: scene-state)
        .route("/admin/api/scene-state/crdt", post(admin::api::scene_state_crdt))
        .route("/admin/api/scene-state/kick-all", post(admin::api::scene_state_kick_all))
        .route("/admin/api/scene-state/reset", post(admin::api::scene_state_reset))
        // credits (bundle: data)
        .route("/admin/api/credits/seasons-list", post(admin::api::credits_seasons_list))
        .route("/admin/api/credits/season-create", post(admin::api::credits_season_create))
        .route("/admin/api/credits/season-update", post(admin::api::credits_season_update))
        .route("/admin/api/credits/season-delete", post(admin::api::credits_season_delete))
        .route("/admin/api/credits/goals-list", post(admin::api::credits_goals_list))
        .route("/admin/api/credits/goal-create", post(admin::api::credits_goal_create))
        .route("/admin/api/credits/goal-update", post(admin::api::credits_goal_update))
        .route("/admin/api/credits/goal-delete", post(admin::api::credits_goal_delete))
        .route("/admin/api/credits/grant", post(admin::api::credits_grant))
        .route("/admin/api/credits/revoke", post(admin::api::credits_revoke))
        .route("/admin/api/credits/user-block", post(admin::api::credits_user_block))
        // price (bundle: data)
        .route("/admin/api/price/override-set", post(admin::api::price_override_set))
        .route("/admin/api/price/override-delete", post(admin::api::price_override_delete))
        // rpc (bundle: data)
        .route("/admin/api/rpc/config", post(admin::api::rpc_config))
        .route("/admin/api/rpc/methods-list", post(admin::api::rpc_methods_list))
        .route("/admin/api/rpc/methods-add", post(admin::api::rpc_methods_add))
        .route("/admin/api/rpc/methods-remove", post(admin::api::rpc_methods_remove))
        .route("/admin/api/rpc/methods-reset", post(admin::api::rpc_methods_reset))
        .route("/admin/api/rpc/networks-list", post(admin::api::rpc_networks_list))
        .route("/admin/api/rpc/networks-set", post(admin::api::rpc_networks_set))
        .route("/admin/api/rpc/networks-delete", post(admin::api::rpc_networks_delete))
        // explorer-api (bundle: explorer-api)
        .route("/admin/api/explorer-api/flags-toggle", post(admin::api::explorer_api_flags_toggle))
        .route("/admin/api/explorer-api/flags-reload", post(admin::api::explorer_api_flags_reload))
        .route("/admin/api/explorer-api/blocklist-add", post(admin::api::explorer_api_blocklist_add))
        .route("/admin/api/explorer-api/blocklist-remove", post(admin::api::explorer_api_blocklist_remove))
        .route("/admin/api/explorer-api/blocklist-reload", post(admin::api::explorer_api_blocklist_reload))
        .route("/admin/api/explorer-api/config-list", post(admin::api::explorer_api_config_list))
        .route("/admin/api/explorer-api/config-get", post(admin::api::explorer_api_config_get))
        .route("/admin/api/explorer-api/config-set", post(admin::api::explorer_api_config_set))
        .route("/admin/api/explorer-api/config-delete", post(admin::api::explorer_api_config_delete))
        .route("/admin/api/explorer-api/challenges-list", post(admin::api::explorer_api_challenges_list))
        .route("/admin/api/explorer-api/challenge-get", post(admin::api::explorer_api_challenge_get))
        .route("/admin/api/explorer-api/challenge-revoke", post(admin::api::explorer_api_challenge_revoke))
        .route("/admin/api/explorer-api/identities-list", post(admin::api::explorer_api_identities_list))
        .route("/admin/api/explorer-api/identity-revoke", post(admin::api::explorer_api_identity_revoke))
        // telemetry (bundle: telemetry)
        .route("/admin/api/telemetry/purge", post(admin::api::telemetry_purge))
        .route("/admin/api/telemetry/ingest", post(admin::api::telemetry_ingest))
        .route("/admin/api/telemetry/quota", post(admin::api::telemetry_quota))
        .route("/admin/api/telemetry/bulk-delete", post(admin::api::telemetry_bulk_delete))
        .route("/admin/api/telemetry/export", post(admin::api::telemetry_export))
        .route("/admin/api/telemetry/audit", post(admin::api::telemetry_audit))
        .route("/admin/api/telemetry/regroup", post(admin::api::telemetry_regroup))
        .route("/admin/api/telemetry/release", post(admin::api::telemetry_release))
