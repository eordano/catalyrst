...
const ENV_DOCS: &[(&str, &str)] = &[
    ...
    (
        "NFT_WORKER_BASE_URL",
        "NFT ownership indexer behind third-party wearables; unset checks the mapped token ids on-chain through RPC_ENDPOINT_ETH / RPC_ENDPOINT_POLYGON",
    ),
    (
        "ENABLE_DEPLOYMENTS",
    ...
    (
        ...
        "POST /entities deployments per client per fixed 24-hour window, counted independently of the burst limit (default 300)",
    ),
