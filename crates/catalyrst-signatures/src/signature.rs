...
pub fn verify_rentals_listing_signature(
    ...
    let sig_str = listing.signature.strip_prefix("0x").unwrap_or(&listing.signature);
...
mod tests {
    ...
    fn accepts_valid_eip712_listing_signature() {
        assert_eq!(verify_rentals_listing_signature(&vector(), 1).unwrap(), true);
    }
    ...
    fn rejects_wrong_signer() {
        ...
        assert_eq!(verify_rentals_listing_signature(&v, 1).unwrap(), false);
    }
