...
The current blob is a pure registry install of the released 7.25.0 toolchain — no
overlays. #1450 (single tree-shakeable ecs) shipped upstream, and #1452 (built-in
utf-8 codec) has now landed too: `@dcl/sdk` 7.25.0 no longer imports
...
docstring carries the evidence for every prune. Current output: **413 files, 12.30 MB
unpacked, 2.29 MB zipped** — down from 2,999 / 45.0 MB / 11.0 MB, most of
