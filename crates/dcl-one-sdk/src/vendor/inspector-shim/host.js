...
/**
 * @param {object} fs the FileSystemInterface from templates/data-layer-host.mjs
 * @returns {Promise<{ rpcMethods: object, engine: import('@dcl/ecs').IEngine }>}
 */
async function createDataLayerHost(fs) {
  ...
  ECS.Composite.instance(engine, resource, provider, {
    entityMapping: {
      ...
      getCompositeEntity: (entity) => entity
    }
  })
