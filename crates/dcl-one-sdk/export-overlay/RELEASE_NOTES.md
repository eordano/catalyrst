...
Release the standalone SDK and its shared authentication, hashing, crypto and tunnel crates as version 0.31.0, aligned with Catalyrst. This release keeps the SDK behavior and embedded server versions from 0.30.0; design notes that described superseded work left the tree.

# dcl-one-sdk v0.30.0

Release the standalone SDK and its shared authentication, hashing, crypto and tunnel crates as version 0.30.0, aligned with Catalyrst. This release keeps the SDK behavior and embedded server versions from 0.29.1.
