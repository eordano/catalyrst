...
pub struct AppStateInner {
    ...
    pub(crate) catalyst_status_cache:
        TtlCell<Option<Arc<crate::modules::realm_provider::CatalystStatus>>>,
    pub(crate) hot_scenes_cache: TtlCell<Arc<Vec<crate::modules::realm_provider::HotSceneInfo>>>,
}
