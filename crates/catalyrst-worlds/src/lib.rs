...
pub fn api_router_with_spec() -> (Router<AppState>, utoipa::openapi::OpenApi) {
    OpenApiRouter::with_openapi(ApiDoc::openapi())
        ...
        .routes(routes!(
            handlers::world_settings::get_world_settings,
            handlers::world_settings::update_world_settings
        ))
        ...
        .routes(routes!(handlers::deploy::deploy_entity).layer(
            axum::extract::DefaultBodyLimit::max(handlers::deploy::MAX_UPLOAD_SIZE_BYTES),
        ))
