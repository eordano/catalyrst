...
-- Faithfully mirrors the governance-archive schema used by the earlier
-- standalone archiver on the reference node. Modeled after the Decentraland governance API response shapes
