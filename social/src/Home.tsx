import { PageHeader, SectionCard } from "@ui/components/Surface";
...
export function Home({ identity, friends, communities, joined, loading, error, onConnect, onRetry, onCreate }: {
  ...
  return <section className="social-home ui-surface" aria-label="Home">
    <PageHeader className="home-heading" title="A little closer, wherever you are." description="Your people. Your communities. Your next adventure." actions={
    ...
    <div className="home-columns">
      <SectionCard className="home-people" title="Friends" titleId="home-people-title" icon={<Icon name="people" />} action={<a href="#/friends">Open inbox <span aria-hidden="true">&#x2197;</span></a>} footer={<><a href="#/nearby"><Icon name="globe" />Find friends out exploring</a></>}>
      ...
      <SectionCard className="home-communities" title="Communities" titleId="home-communities-title" icon={<Icon name="chat" />} action={<a href="#/discover">Discover <span aria-hidden="true">&#x2197;</span></a>} footer={<><a href="#/mine"><Icon name="people" />Your communities</a><button onClick={onCreate} aria-label="Create community from home"><Icon name="plus" /></button></>}>
      ...
      <SectionCard className="home-events" title="Events" titleId="home-events-title" icon={<Icon name="calendar" />} action={<a href="#/events">All events <span aria-hidden="true">&#x2197;</span></a>}>
