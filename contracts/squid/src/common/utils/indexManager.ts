...
// Flatten an index group to the list of indices it manages.
...
/**
 * Check whether any managed index in `group` is missing and needs recreation.
 */
...
/**
 * Log a one-line summary of the managed index configuration.
 */
