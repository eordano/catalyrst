...
/**
 * Empty-leg subset of upstream's offChainMarketplace.test.ts (c931f71). The sale-attribution half of
 * that file pins the #95/#96 seller changes, which this tree does not carry.
 */
