...
Canonical analytics taxonomy for the four operator-facing personas, funnel -> route mapping, and the plan to fold the standalone Builder screens into one Creator Hub. Source of truth for the per-persona dashboard instrumentation stories.
