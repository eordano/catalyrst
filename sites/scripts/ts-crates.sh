...
# needs the bevy nightly + rust-src. Do NOT reintroduce a $DCL_SHELL fallback —
# rig/config.sh exports it as the bevy shell, so honouring it here silently
# builds catalyrst on the wrong toolchain.
ts_rs_shell_run() {
