...
describe("package boundaries", () => {
  ...
  it("cross-package filesystem coupling stays within the pinned inventory", () => {
    ...
    expect(found.sort()).toEqual([
      "packages/core/src/lib/experiments/blog-shop-entry.test.ts -> @sites/features",
      "packages/core/src/lib/experiments/create-entry.test.ts -> @sites/features",
      "packages/core/src/lib/experiments/home-shop-rail.test.ts -> @sites/features",
      "packages/core/src/lib/experiments/open-screen.test.ts -> @sites/features",
      "packages/core/src/lib/experiments/places-shop-entry.test.ts -> @sites/features",
      "packages/core/src/lib/experiments/story-loader.ts -> @sites/features",
      "packages/core/src/lib/experiments/whatson-shop-entry.test.ts -> @sites/features",
