        ...
        rec {
          sites = pkgs.buildNpmPackage {
            ...
            preBuild = ''
              ...
              # vite.config.ts imports ../ui3/vite.validate.js since the
              # perf-parity gate landed — ship the ui3 root files too.
              cp ${ui3}/vite.validate.js ../ui3/
              chmod -R u+w ../ui3
              # ui3 sources resolve bare imports (zod, react, …) upward from
              # ../ui3/*, which never reaches sites/node_modules — expose it
              # at the shared parent so the SSR bundle resolves.
