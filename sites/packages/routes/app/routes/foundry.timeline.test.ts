...
describe("GET /foundry/timeline?before=", () => {
  it("falls back to the top of the lane on an unparsable cursor \u{2014} 200, not 500", async () => {
...
describe("eventHref", () => {
  ...
  it("does not link a scene_note row \u{2014} its note already lives on the changelog row", () => {
  ...
  it("does not link other lanes \u{2014} they keep their own detail-page subjectHref", () => {
