...
export function meta(_args: Route.MetaArgs) {
  return [{ title: "Approve sign-in request — Decentraland" }];
}
  ...
  if (phase === "done") {
    return (
      <Terminal title="Approved">
        {loaded.isDeepLink
          ? "You're all set — return to the app on your device. You can close this tab."
  ...
  return (
    <div style={card}>
      ...
      <p style={{ ...subtle, fontSize: 14, marginTop: 0 }}>
        ...
        tab — someone may be trying to trick you.
      </p>
      ...
      >
        {isSigning ? "Waiting for your wallet…" : "Approve in wallet"}
      </button>
