...
export default function MarketplaceCheckoutRoute({
  ...
  if (resume === undefined) {
    return <LoadingScreen label="Checking for a purchase in progress…" />;
  }
...
function CartCheckout({
  ...
  if (cart === null) {
    return <LoadingScreen label="Loading your cart…" />;
  }
...
function ExpressCheckout({
  ...
  if (line === null || createRun === null) {
    return <LoadingScreen label="Loading this item…" />;
  }
