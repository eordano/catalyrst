...
export function meta() {
  return [{ title: "Exchange \u{2014} The Foundry" }];
}
    ...
    if (
      ...
      const message =
        intent === "create"
          ...
          : intent === "edit"
            ? "Too many writes from this session \u{2014} wait a minute, then save again. Your edit is still in the form."
            : "Too many writes from this session \u{2014} wait a minute, then try again.";
      return data(
