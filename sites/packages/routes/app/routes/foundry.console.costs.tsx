  ...
  if (d.unavailable) {
    return (
      <EmptyState
        ...
        subtitle="Copilot usage is recorded in Postgres. Set FOUNDRY_DATABASE_URL on this deployment to read it."
      />
    );
  }

  return <FdCostsPage usage={d.usage} pricing={d.pricing} />;
}
