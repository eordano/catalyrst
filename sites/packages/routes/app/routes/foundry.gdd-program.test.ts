...
describe("a program-drafted row on the design-doc list", () => {
  ...
  it("says open ground for a brief naming no game \u{2014} a brief proposes nothing", () => {
    expect(html).toContain("open ground \u{2014} no game named");
    expect(html).not.toContain("proposed \u{2014} not built here");
  });
});
