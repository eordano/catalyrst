...
const downService: ServerServiceRow = {
  ...
  httpStatus: 0,
  latencyMs: 1500,
  detail: "connection refused — nothing is listening",
...
describe("ServerOpsPage SSR", () => {
  it("narrates unhealthy state: scoped recheck, watch cadence, ages, commands", () => {
    ...
    expect(html).toContain("1 of 2 up · 1 down · rechecking every 5s until they recover");
    expect(html).toContain("Rechecking…");
    ...
    expect(html).toContain("Disk (/): 60% used · 40.0 GB free");
