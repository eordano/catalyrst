  ...
  if (!asset) {
    return (
      <FlowFallback
        ...
        subtitle={
          fallback
            ? "The item didn't load — it may have been removed, or this is a temporary hiccup. Try again from its page."
            : "Offers start from an item page: open something you like and choose “Make an offer”."
        }
      />
    );
  }
  ...
  return (
    <main className="marketplace-bid">
      <BidWizard
        ...
        banner={
          <MkFlowBanner>
            <strong>Test mode — no real offer will be made.</strong> Offers
