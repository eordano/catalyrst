      ...
      : [
          summary.publishedCollections === null
            ? {
                ...
                value: "Not available",
                note: "Couldn’t load your collections right now.",
                unavailable: true,
              }
            : {
                label: "Published collections",
          ...
          summary.onSaleItems === null
            ? {
                label: "Items on sale",
                value: "Not available",
                note: "Couldn’t load your catalog items right now.",
                unavailable: true,
              }
            : {
                label: "Items on sale",
          ...
          summary.sales7d === null || summary.salesUnavailable
            ? {
                ...
                value: "Not available",
                note: "Couldn’t load your sales right now.",
                unavailable: true,
              }
            : {
                label: `Sales (${windowDays}d)`,
          ...
          summary.scenes === null
            ? {
                ...
                value: "Not available",
                note: "Couldn’t load your places right now.",
                unavailable: true,
              }
            : summary.scenes.places === 0
              ...
              : {
                  ...
                  note: `${fmtCount(summary.scenes.liveNow)} in your scenes now · ${fmtCount(summary.scenes.places)} ${summary.scenes.places === 1 ? "place" : "places"} listed`,
                },
        ];
