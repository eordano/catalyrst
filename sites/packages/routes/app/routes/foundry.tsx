...
const TOUR: readonly TourStep[] = [
  {
    ...
    body:
      "Games by Decentraland creators, deployed to Worlds \u{2014} each game page carries the world it lives in, its size, the deployment entity its date is read from, and a link straight into the client.",
    path: "/foundry/play",
  },
  {
    id: "gdd",
  ...
  },
  {
    ...
    body:
      "Hosts put sessions on the calendar; weekly series repeat for the next 28 days. RSVP to say you'll come \u{2014} the count on each session is everyone who did.",
  ...
  },
  {
    ...
    body:
      "Every scene's record \u{2014} changelog, runs, docs, stewards \u{2014} exports as a JSON bundle you can download and carry elsewhere.",
