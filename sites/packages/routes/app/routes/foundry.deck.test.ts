...
describe("the deck reference page", () => {
  ...
  it("quotes the deck verbatim, archived typos included", () => {
    expect(html).toContain("6\u{2013}24 active players + spectators");
    expect(html).toContain("8\u{2013}50 recurring participants");
    expect(html).toContain("2\u{2013}12 contributors + observers");
