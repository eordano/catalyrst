  ...
  if (!bid && bidSource === "unavailable") {
    return (
      <FlowFallback
        ...
        subtitle={`The marketplace didn't answer, so we can't tell you whether anyone has bid on your items. Don't read this as "no offers" — reload in a moment to try again.${bidReason ? ` (${bidReason})` : ""}`}
