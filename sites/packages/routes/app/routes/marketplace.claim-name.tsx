  ...
  return (
    <main className="marketplace-claim-name" onClickCapture={carryDeployContext}>
      ...
      <ClaimNameWizard
        ...
        banner={
          <MkFlowBanner>
            <strong>Test mode — no real purchase will occur.</strong> NAME
        ...
        creditsNote="Credits can't be used for NAMEs yet — Credits checkout only supports collection items."
        onReturnToPublish={
          fromDeploy
            ? (worldName) => {
                track(
