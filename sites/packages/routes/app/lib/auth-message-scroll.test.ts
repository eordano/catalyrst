...
describe("isScrolledToEnd", () => {
  it("counts a block as read once it does not overflow or sits within two pixels of its end", () => {
    const cases: [Parameters<typeof isScrolledToEnd>[0], boolean][] = [
      ...
      [{ scrollHeight: 2000, scrollTop: 1777, clientHeight: 220 }, false],
      [{ scrollHeight: 2000, scrollTop: 1780, clientHeight: 220 }, true],
      [{ scrollHeight: 400, scrollTop: 198, clientHeight: 200 }, true],
      [{ scrollHeight: 400, scrollTop: 197, clientHeight: 200 }, false],
      [{ scrollHeight: 2000.6, scrollTop: 1780, clientHeight: 220 }, true],
      [{ scrollHeight: 2003, scrollTop: 1780, clientHeight: 220 }, false],
