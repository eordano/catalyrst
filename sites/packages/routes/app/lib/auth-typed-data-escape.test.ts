...
// The strings auth/src/shared/auth/typedDataReview.spec.ts holds the review to, with the escapes it
// expects: a character that acts on the display is shown, never obeyed.
describe("escapeUnreadableTypedDataText", () => {
  it.each([
    ...
    ["a narrow no-break space", "Trusted\u{202f}App", "Trusted\\u{202f}App"],
    ["an ideographic space", "Decentraland\u{3000}", "Decentraland\\u{3000}"],
    [
