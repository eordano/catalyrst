...
export const LANDING_STORIES: LandingStory[] = [
  {
    ...
    subhead:
      "Build a 3D world people show up for — open, yours, and unkillable.",
    beats: [
      {
        title: "Press play in seconds",
        body: "Build in the browser, drop in a cube, and watch your avatar walk your scene — no engine install, no build wait.",
      ...
      },
      {
        ...
        body: "Launch into a dense destination where players already are — not an empty parcel.",
        cta: { label: "Explore the map", href: "/places" },
      },
    ],
    cta: { label: "Start building — free", href: "/create" },
  },
  {
    id: "wearables",
    ...
    subhead:
      "Design wearables and emotes, publish in minutes, and sell them inside the world — you keep the upside and the IP.",
    beats: [
      {
        title: "Publish, don't wait",
        body: "A fast, predictable pipeline: submit, get listed, sell — no black-box queue.",
        cta: { label: "Start a collection", href: "/create/wearables" },
      },
      {
        title: "Paid where people already are",
        body: "Buyers pay in stable, dollar-priced Credits right inside the experience — no wallet gymnastics.",
        cta: { label: "How Credits work", href: "/marketplace/credits" },
      },
      {
        title: "Your work keeps working",
        body: "Every item is a real asset your buyers own and can resell — it travels, and it keeps earning.",
    ...
    beats: [
      {
        ...
        body: "Web and no-code up to the full SDK and VS Code — prototype fast, scale to production.",
        cta: { label: "Explore the tools", href: "/create/learn" },
      },
      {
        title: "Recurring rails, built in",
        body: "In-scene payments, ticketed events, and items — all priced in USD.",
  ...
  },
  {
    ...
    subhead:
      "Describe it, drop in a few things, press play. No code, no downloads — your first social experience, live in the browser.",
    beats: [
      {
        title: "Start from a prompt, not a blank engine",
        body: "AI-assisted creation and drag-and-drop building get you to “it's alive” fast.",
        cta: { label: "Make your first scene", href: "/create" },
      },
      {
        title: "Yours the moment you make it",
        body: "Free to open, change, and share — no gatekeepers.",
  ...
  },
  {
    ...
    kind: "user",
    voice: "nightlife energy, FOMO; the user who comes to hang out, not to “use a metaverse”",
    headline: "The party already started.",
    subhead:
      "Drop into live events, games, and rooms full of real people — no download, just a link. Show up as anyone you want.",
    beats: [
      {
        title: "Something's on right now",
        body: "Parties, tournaments, openings — not an empty map to wander.",
        cta: { label: "See what's on", href: "/whats-on" },
      },
      {
        title: "Your look is the opener",
        body: "Your avatar, your style, your expression — the fun starts before the game does.",
  ...
  },
  {
    ...
    subhead:
      "Wearables, names, land, items — when you buy here, it's yours to keep, sell, or take with you. No landlord, no reset button.",
    beats: [
      {
      ...
      },
      {
        ...
        body: "Stable, dollar-priced Credits — collect and trade on predictable terms.",
