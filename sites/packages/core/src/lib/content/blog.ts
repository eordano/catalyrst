    ...
    body: [
      ...
      { type: "h3", content: "What you need" },
      {
        ...
        items: [
          ...
          "Nothing else — no installer, no launcher",
        ],
      },
      {
        type: "p",
  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        type: "p",
        content:
          "The listing reflects the event data this node serves — no editorial curation, just what's actually scheduled. Check it out at /whats-on.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      { type: "h3", content: "How the season works" },
      {
        type: "ul",
        items: [
          "Season One runs from June 29 to August 24, 2026 — eight weekly rounds",
