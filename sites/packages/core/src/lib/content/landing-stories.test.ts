...
describe("getLandingStory — resolution + fallback", () => {
...
describe("resolveAudienceFromParams — UTM/query mapping", () => {
...
describe("pickLandingStory — utm / sticky / random", () => {
  ...
  it("sticky: same seed → same story, tagged via=sticky", () => {
