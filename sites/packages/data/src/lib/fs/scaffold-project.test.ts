...
describe("buildScaffoldFiles — scene.json carries the typed name + layout", () => {
...
describe("buildScaffoldFiles — main.composite reflects the template/seed", () => {
...
describe("buildScaffoldFiles — template recorded in the scaffold", () => {
...
describe("writeScaffoldFiles — real disk write", () => {
