...
describe("composeEditedScene — pure edit → composite", () => {
  ...
  it("round-trips through serialize→parse with the edit intact", () => {
    const c = composeEditedScene(HIERARCHY, {
      placed: { entity: 540, assetName: "Oak Tree", parent: 0 },
    });
...
describe("saveSceneComposite — honest write outcomes", () => {
...
describe("sanitizeContentPath — aliases filenames the local FS rejects", () => {
...
describe("rewriteAliasedPaths — composite references follow the alias", () => {
