...
-- 0024-build-request end-state (lockstep with migrations/0024-build-request.sql).
-- A recorded ask to build a design doc into a playable scene, and the broker's
-- status ledger for that ask. scene_slug is NOT an FK: the foundry.scene row
-- exists only after the build lands (registerScene mints it).
