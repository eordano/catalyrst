...
describe("replaceSceneJobs", () => {
  it("replaces a scene's whole set \u{2014} a re-read that drops a job removes its row", async () => {
...
describe("listSceneJobs", () => {
  ...
  it("returns an empty array for a scene never read \u{2014} nothing fabricated", async () => {
