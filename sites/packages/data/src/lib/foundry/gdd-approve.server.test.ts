...
describe("approveGddDoc", () => {
  ...
  it("refuses without a claimed persona \u{2014} a signature needs a name", async () => {
    await expect(
  ...
  it("signs from an aliased sid: named, landed canonically \u{2014} the rosa/finding-30 shape", async () => {
