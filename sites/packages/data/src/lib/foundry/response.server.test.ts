...
describe("revisionSplit", () => {
  ...
  it("is null when the deploy predates every measured day \u{2014} no revision to read", () => {
...
describe("reportLine \u{2014} the arena rule, server-side", () => {
...
describe("readResponseSignals", () => {
  it("aggregates visits, replays and downloads into counts \u{2014} never badge lists", async () => {
