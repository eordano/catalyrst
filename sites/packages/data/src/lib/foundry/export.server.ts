...
export async function buildProjectBundle(
  ...
  return {
    provenance: {
      ...
      note: "Assembly time of this bundle on the server clock \u{2014} not a deployment fact. No scene bytes and no secrets (transfer codes, session ids) are included; every actor is a claimed persona name or a session badge.",
    },
    scene,
    changelog,
    docs,
