...
describe("loadGrantBudget", () => {
  it("calls /budgets — the path this node routes — not the upstream /budget/all", async () => {
  ...
  it("reports an unavailable state on a non-2xx — it must not serve the fixture", async () => {
