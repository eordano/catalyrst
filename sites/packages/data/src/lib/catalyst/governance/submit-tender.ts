...
export const TENDER_TEXT_SECTIONS = [
  "summary",
  "problem_statement",
...
const FALLBACK: SubmitTenderData = {
  ...
  success: {
    ...
    note: "This Tender was created in a simulation — no on-chain transaction or Snapshot proposal was submitted.",
  },
 ...
 * of `GET /proposals`) with its rows narrowed to the pick above. The hand
 * envelope this replaces tolerated a missing `limit`/`offset`; the wire
 * always carries both.
 */
