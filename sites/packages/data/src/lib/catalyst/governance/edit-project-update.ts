 ...
 * (catalyrst-governance/src/handlers/read.rs:201 → parse.rs:151). This module
 * used to call GET /updates?project_id=, which this node has never served —
 * lib.rs:29-44 registers no such route — and the 404 was absorbed into a
 * fixture, so the edit form has always been editing invented text.
 */
