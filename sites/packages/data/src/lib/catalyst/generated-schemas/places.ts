...
import type { CategoryI18n } from "@ui/generated/catalyst/places/CategoryI18n";
...
import type { DestinationCategory } from "@ui/generated/catalyst/places/DestinationCategory";
import type { DestinationNextEvent } from "@ui/generated/catalyst/places/DestinationNextEvent";
import type { EntityType } from "@ui/generated/catalyst/places/EntityType";
...
import type { InteractionSummary } from "@ui/generated/catalyst/places/InteractionSummary";
...
import type { ReplaceRankingPlaces } from "@ui/generated/catalyst/places/ReplaceRankingPlaces";
import type { ReplaceRankingResult } from "@ui/generated/catalyst/places/ReplaceRankingResult";
import type { ReplaceRankingWorlds } from "@ui/generated/catalyst/places/ReplaceRankingWorlds";
...
export const CategoryI18nSchema = z.object({
  en: z.string(),
});
...
export const EntityTypeSchema = z.enum(["place", "world"]);
...
export const DestinationSchema = z.object({
  ...
  live_event_name: z.string().nullable().optional(),
  next_event: z.object({
    id: z.string(),
    name: z.string(),
    next_start_at: z.string(),
  }).nullable().optional(),
...
export const DestinationCategorySchema = z.object({
  name: z.string(),
  count: z.number(),
  i18n: CategoryI18nSchema,
});

export const DestinationNextEventSchema = z.object({
  id: z.string(),
  name: z.string(),
  next_start_at: z.string(),
});
...
export const PlaceRowSchema = z.object({
  ...
  highlighted_image: z.string().nullable(),
  ranking: z.number().nullable(),
  exclude_from_ranking: z.boolean(),
  sdk: z.string().nullable(),
  creator_address: z.string().nullable(),
...
export const ReplaceRankingPlacesSchema = z.object({
  applied: z.number(),
  cleared: z.number(),
  skipped_curated: z.array(z.string()),
  skipped_world_backed: z.array(z.string()),
  skipped_missing: z.array(z.string()),
});

export const ReplaceRankingWorldsSchema = z.object({
  applied: z.number(),
  cleared: z.number(),
  skipped_curated: z.array(z.string()),
  skipped_missing: z.array(z.string()),
...
export const ReplaceRankingResultSchema = z.object({
  places: ReplaceRankingPlacesSchema,
  worlds: ReplaceRankingWorldsSchema,
});
...
export type _AssertCategoryI18n = Assert<Mutual<CategoryI18n, z.infer<typeof CategoryI18nSchema>>>;
...
export type _AssertDestinationCategory = Assert<Mutual<DestinationCategory, z.infer<typeof DestinationCategorySchema>>>;
export type _AssertDestinationNextEvent = Assert<Mutual<DestinationNextEvent, z.infer<typeof DestinationNextEventSchema>>>;
export type _AssertEntityType = Assert<Mutual<EntityType, z.infer<typeof EntityTypeSchema>>>;
...
export type _AssertInteractionSummary = Assert<Mutual<InteractionSummary, z.infer<typeof InteractionSummarySchema>>>;
...
export type _AssertReplaceRankingPlaces = Assert<Mutual<ReplaceRankingPlaces, z.infer<typeof ReplaceRankingPlacesSchema>>>;
export type _AssertReplaceRankingResult = Assert<Mutual<ReplaceRankingResult, z.infer<typeof ReplaceRankingResultSchema>>>;
export type _AssertReplaceRankingWorlds = Assert<Mutual<ReplaceRankingWorlds, z.infer<typeof ReplaceRankingWorldsSchema>>>;
