 ...
 * from it. A failed read used to say "this world has no scenes" — which reads
 * as "this world does not exist" on one page and "there is nothing to
 * unpublish" on the other.
 */
