...
describe("loadCreatorMetrics — failure must not masquerade as emptiness", () => {
  it("collections source down (503) → null count, and NOT the empty state", async () => {
  ...
  it("items source down → null count, not empty", async () => {
  ...
  it("sales source down while collections exist → salesUnavailable, not empty", async () => {
  ...
  it("all sources down → loadError, never empty", async () => {
...
describe("loadCreatorMetrics — real data and genuine emptiness still work", () => {
