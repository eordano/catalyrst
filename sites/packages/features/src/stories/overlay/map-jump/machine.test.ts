...
describe("mapJumpMachine — URL ?step slug map", () => {
...
describe("mapJumpMachine — deep-link hydration", () => {
...
describe("mapJumpMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("mapJumpMachine — telemetry events (happy path)", () => {
...
describe("mapJumpMachine — teleport failure + retry", () => {
