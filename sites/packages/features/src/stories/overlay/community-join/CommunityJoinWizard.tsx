      ...
      <header style={DETAIL_HEAD}>
        <div>
          ...
          <div style={{ color: "rgba(255,255,255,.85)", fontWeight: 600 }}>
            {isPublic ? "🌐 Public" : "🔒 Private"} · {memberCountLabel(community.membersCount)} Members
            {isLive ? "  ·  🔴 Live" : ""}
          </div>
          {community.ownerName ? (
  ...
  return (
    <section className="cm__main" style={{ width: "100%" }}>
      ...
      <p style={{ color: "rgba(255,255,255,.85)", maxWidth: 640, lineHeight: 1.5 }}>
        ...
        {real ? "" : " (Simulated — sign in to write.)"}
      </p>
      {real ? null : (
        <p style={SIM_NOTE}>
...
function CommitProgress({
  ...
  return (
    <section className="cm__main" style={{ width: "100%" }}>
      <h1 className="cm__title">{action === "request" ? "Sending request…" : "Joining…"}</h1>
...
function DoneView({
  ...
  return (
    <section className="cm__main" style={{ width: "100%" }}>
      <h1 className="cm__title">{pending ? "Request sent ✓" : "Joined ✓"}</h1>
      <p style={{ color: "rgba(255,255,255,.85)", maxWidth: 640, lineHeight: 1.5 }}>
        {pending
