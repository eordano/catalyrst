...
describe("communityJoinMachine — URL ?step slug map", () => {
...
describe("communityJoinMachine — deep-link hydration", () => {
...
describe("communityJoinMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("communityJoinMachine — public JOIN funnel", () => {
...
describe("communityJoinMachine — private REQUEST funnel", () => {
...
describe("communityJoinMachine — commit failure + retry", () => {
