...
describe("outfitSaveMachine — URL ?step slug map", () => {
...
describe("outfitSaveMachine — deep-link hydration", () => {
...
describe("outfitSaveMachine — model-based path coverage", () => {
...
describe("outfitSaveMachine — happy path (free slot, simulated save)", () => {
...
describe("outfitSaveMachine — NAME-gate (real)", () => {
