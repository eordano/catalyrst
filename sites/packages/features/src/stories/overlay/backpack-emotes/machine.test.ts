...
describe("emotesMachine — URL ?step slug map", () => {
...
describe("emotesMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("emotesMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("emotesMachine — telemetry events (happy path)", () => {
...
describe("emotesMachine — save failure + retry", () => {
