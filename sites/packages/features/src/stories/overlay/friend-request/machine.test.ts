...
describe("friendMachine — URL ?step slug map", () => {
...
describe("transitionValid — mirrors catalyrst-social-rpc service.rs", () => {
...
describe("friendMachine — deep-link hydration (no telemetry double-fire)", () => {
...
describe("friendMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("friendMachine — telemetry events", () => {
