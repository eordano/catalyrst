...
describe("communityMachine \u{2014} URL ?step slug map", () => {
  it("maps every state to a unique round-tripping slug, falls back to create, and orders the form steps", () => {
...
describe("communityMachine \u{2014} model-based path coverage (@xstate/graph)", () => {
  it("without a NAME every path ends in an expected state via the gate; with a NAME the gate is skipped", () => {
