...
describe("communityMachine — URL ?step slug map", () => {
...
describe("communityMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("communityMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("communityMachine — telemetry events (happy path, no NAME)", () => {
...
describe("communityMachine — NAME gate skip (owns a NAME)", () => {
...
describe("communityMachine — guards", () => {
...
describe("communityMachine — submit failure + retry", () => {
