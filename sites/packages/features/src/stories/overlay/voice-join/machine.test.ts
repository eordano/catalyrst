...
describe("voiceMachine — URL ?step slug map", () => {
...
describe("voiceMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("voiceMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("voiceMachine — telemetry events (happy path)", () => {
...
describe("voiceMachine — connect failure + retry", () => {
