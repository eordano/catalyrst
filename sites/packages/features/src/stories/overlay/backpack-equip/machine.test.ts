...
describe("backpackMachine — URL ?step slug map", () => {
...
describe("backpackMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("backpackMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("backpackMachine — telemetry events (happy path)", () => {
...
describe("backpackMachine — save failure + retry", () => {
...
describe("simulateSave", () => {
  it("resolves a deterministic stub entity id (no network)", async () => {
    const a = await simulateSave({ wearables: ["a", "b"] });
    const b = await simulateSave({ wearables: ["a", "b"] });
    const c = await simulateSave({ wearables: ["a", "c"] });
