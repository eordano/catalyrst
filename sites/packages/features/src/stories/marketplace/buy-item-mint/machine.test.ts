...
describe("buyMintMachine — URL ?step slug map", () => {
...
describe("buyMintMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("buyMintMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("buyMintMachine — telemetry events (happy path)", () => {
...
describe("buyMintMachine — failure + retry", () => {
