...
describe("sellMachine — URL ?step slug map", () => {
...
describe("sell.ts — MANA <-> wei + order build", () => {
...
describe("sellMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("sellMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("sellMachine — telemetry events (happy path)", () => {
...
describe("sellMachine — order-create failure + retry", () => {
