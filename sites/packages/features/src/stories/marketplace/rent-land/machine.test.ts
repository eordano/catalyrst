...
describe("rentMachine — URL ?step slug map", () => {
...
describe("rentMachine — deep-link hydration", () => {
...
describe("rentMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("rentMachine — telemetry events (happy path)", () => {
...
describe("rentMachine — commit failure + retry", () => {
