...
describe("acceptBidMachine — URL ?step slug map", () => {
...
describe("acceptBidMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("acceptBidMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("acceptBidMachine — telemetry events (happy path)", () => {
...
describe("acceptBidMachine — failure + retry", () => {
