...
describe("claimNameMachine — URL ?step slug map", () => {
...
describe("claimNameMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("claimNameMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("claimNameMachine — telemetry events (happy path)", () => {
...
describe("claimNameMachine — mint failure + retry", () => {
