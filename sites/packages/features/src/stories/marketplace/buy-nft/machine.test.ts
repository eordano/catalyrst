...
describe("buyMachine — URL ?step slug map", () => {
...
describe("buyMachine — deep-link hydration", () => {
...
describe("buyMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("buyMachine — telemetry events (happy path)", () => {
...
describe("buyMachine — failure + retry", () => {
