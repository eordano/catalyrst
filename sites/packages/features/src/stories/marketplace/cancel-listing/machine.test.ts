...
describe("cancelMachine — URL ?step slug map", () => {
...
describe("cancelMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("cancelMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("cancelMachine — telemetry events (happy path)", () => {
...
describe("cancelMachine — cancel failure + retry", () => {
