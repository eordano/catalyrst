...
describe("transferMachine — URL ?step slug map", () => {
...
describe("transferMachine — deep-link hydration", () => {
...
describe("transferMachine — model-based path coverage", () => {
...
describe("transferMachine — telemetry events (happy path)", () => {
...
describe("transferMachine — invalid recipient guardrail", () => {
...
describe("transferMachine — submit failure + retry", () => {
