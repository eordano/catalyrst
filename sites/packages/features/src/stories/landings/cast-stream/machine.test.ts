...
describe("castMachine — URL ?step slug map", () => {
...
describe("castMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("castMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("castMachine — happy path (token -> devices -> permissions -> preview -> live)", () => {
...
describe("castMachine — invalid token path", () => {
...
describe("castMachine — permission denial path (guardrail)", () => {
...
describe("castMachine — screen-share in live (simulated LiveKit publish)", () => {
