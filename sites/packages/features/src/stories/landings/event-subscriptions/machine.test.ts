...
describe("subscriptionMachine — URL ?step slug map", () => {
...
describe("subscriptionMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("subscriptionMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("subscriptionMachine — telemetry events (happy path)", () => {
...
describe("subscriptionMachine — error + retry", () => {
