...
describe("scheduleMachine — URL ?step slug map", () => {
...
describe("scheduleMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("scheduleMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("scheduleMachine — telemetry events (happy path)", () => {
...
describe("scheduleMachine — submit failure + retry", () => {
