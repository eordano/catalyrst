...
describe("scheduleMachine \u{2014} model-based path coverage (@xstate/graph)", () => {
  it("the funnel states are event-reachable and review takes SIGN_IN plus two NEXTs", () => {
...
describe("simulateSubmit", () => {
  it("mints an id on create, preserves the id on edit, and rejects a nameless draft", async () => {
