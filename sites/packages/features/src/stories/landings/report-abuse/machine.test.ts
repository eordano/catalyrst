...
describe("reportMachine — URL ?step slug map", () => {
...
describe("reportMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("reportMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("reportMachine — telemetry events (happy path)", () => {
...
describe("reportMachine — validation guardrails (self-loops)", () => {
...
describe("reportMachine — submit failure + retry", () => {
