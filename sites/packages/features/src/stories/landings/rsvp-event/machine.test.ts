...
describe("rsvpMachine — URL ?step slug map", () => {
...
describe("rsvpMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("rsvpMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("rsvpMachine — RSVP going (happy path)", () => {
...
describe("rsvpMachine — cancel RSVP", () => {
...
describe("rsvpMachine — commit failure + retry", () => {
...
describe("simulateCommit", () => {
  it("increments on going, decrements (floored at 0) on cancel — no network", async () => {
