      ...
      <div className="submit-hangout__fields">
        ...
        {categories.length > 0 ? (
          ...
          <p className="submit-hangout__hint" role="status">
            {categoriesError
              ? "Categories couldn't be loaded right now — you can continue and pick one later."
              : "No categories are available right now — you can continue without one."}
          </p>
        )}
      </div>
    );
    ...
    <div className="submit-hangout__review">
      ...
      <dl className="submit-hangout__reviewlist">
        ...
        <dd>
          ...
          {draft.recurrent ? ` · repeats until ${draft.recurrentUntil || "—"}` : ""}
        </dd>
        <dt>Where</dt>
        <dd>
