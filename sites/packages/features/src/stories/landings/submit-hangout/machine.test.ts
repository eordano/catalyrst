...
describe("hangoutMachine \u{2014} URL ?step slug map", () => {
  it("maps every state to a unique round-tripping slug, falling back to signin-gate", () => {
...
describe("hangoutMachine \u{2014} model-based path coverage (@xstate/graph)", () => {
  it("the funnel states are event-reachable and review needs SIGN_IN plus the form NEXTs", () => {
