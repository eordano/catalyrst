...
describe("hangoutMachine — URL ?step slug map", () => {
...
describe("hangoutMachine — deep-link hydration", () => {
...
describe("hangoutMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("hangoutMachine — per-step validation guards", () => {
...
describe("hangoutMachine — telemetry (happy path)", () => {
...
describe("hangoutMachine — submit failure", () => {
