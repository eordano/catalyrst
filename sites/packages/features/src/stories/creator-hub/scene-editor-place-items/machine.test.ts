...
describe("editorMachine \u{2014} URL ?step slug map", () => {
...
describe("editorMachine \u{2014} deep-link hydration (snapshot, no event replay)", () => {
...
describe("editorMachine \u{2014} model-based path coverage (@xstate/graph)", () => {
...
describe("editorMachine \u{2014} telemetry events (happy path)", () => {
...
describe("editorMachine \u{2014} save placed item without a component (fewer clicks)", () => {
...
describe("editorMachine \u{2014} modify phase (edit a real entity)", () => {
...
describe("editorMachine \u{2014} save failure + retry", () => {
...
describe("editorMachine \u{2014} minimal-clicks contract (place & save)", () => {
