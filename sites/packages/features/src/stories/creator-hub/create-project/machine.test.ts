...
describe("createProjectMachine — URL ?step slug map", () => {
...
describe("createProjectMachine — deep-link hydration (snapshot, no event replay)", () => {
  ...
  it("run-scoped steps (scaffold/created/error) are NOT cold-resumable — they fall back to naming", async () => {
    const track = vi.fn();
...
describe("createProjectMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("createProjectMachine — telemetry events (happy path)", () => {
...
describe("createProjectMachine — invalid name guardrail", () => {
...
describe("createProjectMachine — preselected template skips templating", () => {
...
describe("createProjectMachine — scaffold failure + retry", () => {
...
describe("createProjectMachine — name error surface + project slug", () => {
...
describe("CreateProjectView — created screen create->edit seam", () => {
...
describe("CreateProjectView — dismissed-picker error offers folder recovery", () => {
  it("a cancellation error shows [Choose folder again] as the primary action", () => {
    const html = renderToStaticMarkup(
      createElement(CreateProjectView, {
        view: "error",
        error: "Scene creation canceled — no folder was chosen.",
      }),
    );
    expect(html).toContain(
      "Scene creation was cancelled — no folder was chosen.",
    );
...
describe("createProjectMachine — minimal-clicks contract", () => {
