...
`rig/docs/mp-scene-testing-design.md` §3.5 and `tools/mp-testd/spec.md`.
...
4. **reviewing** — ReportView: metric cards (convergence, corrections, join
   ...
   Lane-honest claim copy per the design §2 matrix.
...
directory implements the §3.5 surface (auth, REST, /events ws, scripted
