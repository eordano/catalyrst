...
describe("mpPanelMachine — pairing", () => {
...
describe("mpPanelMachine — launch", () => {
...
describe("mpPanelMachine — run lifecycle", () => {
  ...
  it("walks starting → running → analyzing without leaving the running state", async () => {
...
describe("mpPanelMachine — reviewing + replay substate", () => {
