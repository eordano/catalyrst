...
describe("worldSettingsMachine — URL ?step slug map", () => {
...
describe("worldSettingsMachine — deep-link hydration", () => {
...
describe("worldSettingsMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("worldSettingsMachine — telemetry events (happy path)", () => {
...
describe("worldSettingsMachine — save failure + retry", () => {
...
describe("worldSettingsMachine — stub telemetry contract", () => {
  ...
  it("an injected real SaveFn (stub:false) emits stub:false — the seam is honest without machine changes", async () => {
