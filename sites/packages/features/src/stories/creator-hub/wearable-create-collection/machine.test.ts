...
describe("create-collection — pure helpers", () => {
  ...
  it("publishCost: standard pays feePerItem × count, linked pays 0", () => {
...
describe("createCollectionMachine — URL ?step slug map", () => {
...
describe("createCollectionMachine — deep-link hydration", () => {
...
describe("createCollectionMachine — model-based path coverage", () => {
...
describe("createCollectionMachine — telemetry events (happy path)", () => {
...
describe("createCollectionMachine — submit failure + retry", () => {
...
describe("createCollectionMachine — GOTO (browser back/forward sync)", () => {
