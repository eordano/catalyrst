...
describe("permissionsMachine — URL ?step slug map", () => {
...
describe("permissionsMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("permissionsMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("permissionsMachine — telemetry events (happy path)", () => {
...
describe("permissionsMachine — add-collaborator validation", () => {
...
describe("permissionsMachine — commit failure + retry", () => {
...
describe("permissionsMachine — stub telemetry contract", () => {
  ...
  it("an injected real CommitFn (stub:false) emits stub:false — the seam is honest without machine changes", async () => {
...
describe("permissionsMachine — minimal-clicks contract", () => {
