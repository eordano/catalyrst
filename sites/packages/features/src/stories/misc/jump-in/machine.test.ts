...
describe("jumpInMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("jumpInMachine — telemetry events (control)", () => {
...
describe("jumpInMachine — telemetry events (treatment)", () => {
