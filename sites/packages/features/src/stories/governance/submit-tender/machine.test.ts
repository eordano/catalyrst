...
describe("tenderMachine — URL ?step slug map", () => {
...
describe("tenderMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("tenderMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("tenderMachine — telemetry events (happy path)", () => {
...
describe("tenderMachine — VP gate", () => {
...
describe("tenderMachine — submit failure + retry", () => {
