...
describe("bidVoteMachine — URL ?step slug map", () => {
...
describe("bidVoteMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("bidVoteMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("bidVoteMachine — the reckon gate", () => {
...
describe("bidVoteMachine — telemetry events (happy path)", () => {
...
describe("bidVoteMachine — cast failure + retry + snapshot escalation", () => {
