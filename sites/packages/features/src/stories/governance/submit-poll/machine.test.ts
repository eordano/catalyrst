...
describe("submitPollMachine — URL ?step slug map", () => {
...
describe("submitPollMachine — validation helpers", () => {
...
describe("submitPollMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("submitPollMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("submitPollMachine — telemetry (happy path)", () => {
...
describe("submitPollMachine — VP/connect gate (guardrail)", () => {
...
describe("submitPollMachine — invalid steps cannot advance", () => {
...
describe("submitPollMachine — submit failure + retry", () => {
