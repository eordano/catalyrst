...
describe("hiringMachine — URL ?step slug map", () => {
...
describe("hiringMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("hiringMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("hiringMachine — telemetry events (happy path)", () => {
...
describe("hiringMachine — inline validation (guardrail)", () => {
...
describe("hiringMachine — submit failure + retry", () => {
