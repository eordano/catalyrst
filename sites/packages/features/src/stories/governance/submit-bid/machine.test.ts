...
describe("bidMachine — URL ?step slug map", () => {
...
describe("bidMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("bidMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("bidMachine — telemetry events (happy path)", () => {
...
describe("bidMachine — submit failure + retry", () => {
