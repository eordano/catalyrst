...
describe("govProposalMachine — URL ?step slug map", () => {
...
describe("govProposalMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("govProposalMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("govProposalMachine — telemetry events (happy path)", () => {
...
describe("govProposalMachine — VP gate (>=2500 VP)", () => {
...
describe("govProposalMachine — details validation", () => {
...
describe("govProposalMachine — submit failure + retry", () => {
