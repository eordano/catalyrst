...
describe("delegateMachine — URL ?step slug map", () => {
...
describe("delegateMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("delegateMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("delegateMachine — telemetry events (happy path)", () => {
...
describe("delegateMachine — signature failure + retry", () => {
