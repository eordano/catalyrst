...
describe("pitchMachine — URL ?step slug map", () => {
...
describe("pitchMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("pitchMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("pitchMachine — VP submission gate", () => {
...
describe("pitchMachine — telemetry events (happy path)", () => {
...
describe("pitchMachine — invalid details", () => {
...
describe("pitchMachine — BACK navigation", () => {
...
describe("pitchMachine — submit failure + retry", () => {
