...
describe("submitCouncilVetoMachine — URL ?step slug map", () => {
...
describe("submitCouncilVetoMachine — deep-link hydration", () => {
...
describe("submitCouncilVetoMachine — model-based path coverage", () => {
...
describe("submitCouncilVetoMachine — telemetry (happy path)", () => {
...
describe("submitCouncilVetoMachine — submit failure + retry", () => {
