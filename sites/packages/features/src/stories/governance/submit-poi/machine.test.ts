...
describe("poiMachine — URL ?step slug map", () => {
...
describe("poiMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("poiMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("poiMachine — telemetry events (happy path)", () => {
...
describe("poiMachine — inline validation (guardrail)", () => {
...
describe("poiMachine — submit failure + retry", () => {
