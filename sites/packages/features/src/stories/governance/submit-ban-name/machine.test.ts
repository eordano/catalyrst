...
describe("banNameMachine — URL ?step slug map", () => {
...
describe("banNameMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("banNameMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("banNameMachine — telemetry events (happy path)", () => {
...
describe("banNameMachine — submit failure + retry", () => {
