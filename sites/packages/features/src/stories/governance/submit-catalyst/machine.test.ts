...
describe("submitCatalystMachine — URL ?step slug map", () => {
...
describe("submitCatalystMachine — deep-link hydration", () => {
...
describe("submitCatalystMachine — model-based path coverage", () => {
...
describe("submitCatalystMachine — telemetry (happy path)", () => {
...
describe("submitCatalystMachine — submit failure + retry", () => {
