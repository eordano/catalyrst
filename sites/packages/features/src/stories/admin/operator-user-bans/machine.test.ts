...
describe("userBanMachine — URL ?step slug map", () => {
...
describe("userBanMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("userBanMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("userBanMachine — commit telemetry (happy paths)", () => {
...
describe("userBanMachine — faithful failure paths (server error contracts)", () => {
