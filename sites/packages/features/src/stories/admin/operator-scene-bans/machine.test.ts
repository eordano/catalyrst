...
const PLACE = "f888b899-c509-44d1-af21-717a4cef654e";
...
describe("sceneBanMachine — URL ?step slug map", () => {
...
describe("sceneBanMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("sceneBanMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("sceneBanMachine — ban happy path", () => {
...
describe("sceneBanMachine — unban path", () => {
...
describe("sceneBanMachine — invalid target is gated", () => {
...
describe("sceneBanMachine — commit failure + retry", () => {
...
describe("sceneBanMachine — RESET returns to the (updated) list", () => {
