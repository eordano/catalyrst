...
describe("manageMachine — URL ?step slug map", () => {
...
describe("manageMachine — deep-link hydration (snapshot, no event replay)", () => {
...
describe("manageMachine — model-based path coverage (@xstate/graph)", () => {
...
describe("manageMachine — add (grant) happy path", () => {
...
describe("manageMachine — revoke happy path", () => {
...
describe("manageMachine — REVIEW guard (form readiness)", () => {
...
describe("manageMachine — simulated commit failure", () => {
