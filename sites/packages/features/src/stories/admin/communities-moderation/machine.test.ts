...
describe("adminCommunitiesModerate — URL ?step slug map", () => {
...
describe("adminCommunitiesModerate — deep-link hydration (snapshot, no event replay)", () => {
...
describe("adminCommunitiesModerate — model-based path coverage (@xstate/graph)", () => {
...
describe("adminCommunitiesModerate — telemetry events (happy path: suspend)", () => {
...
describe("adminCommunitiesModerate — commit failure + retry", () => {
