...
function CommunitiesPane({
  ...
  return (
    <SocialSurface
      ...
      convSubtitle={
        active ? `${memberCountLabel(active.membersCount)} · community channel` : undefined
      }
      convAvatarUrl={thumbUrl(active?.thumb ?? null)}
      members={memberChips}
      messages={messages}
      threadStatus={threadStatus}
      threadEmptyText="No posts in this channel yet — start the conversation."
      showAuthors
      canPost={canPost}
      composerHint={
        active
          ? "Only owners and moderators can post in this channel — you can read it here."
          : undefined
      }
      composerPlaceholder="Post to this channel…"
      draft={draft}
      onDraft={setDraft}
      onSend={onSend}
      sending={sending}
...
function FriendsPane({
  ...
  return (
    <SocialSurface
      ...
      messages={messages}
      threadStatus={threadStatus}
      threadEmptyText="No messages yet — say hello."
      canPost={!!active}
      composerPlaceholder="Message your friend…"
      draft={draft}
      onDraft={setDraft}
      onSend={onSend}
      sending={sending}
