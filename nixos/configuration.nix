...
let
  ...
  bundleCommonEnv = {
    ...
    FAVORITES_PG_COMPONENT_PSQL_CONNECTION_STRING = connBundle "marketplace_squid";
      ...
      // lib.optionalAttrs cfg.subServices.data {
        catalyrst-data = mkBundle {
          ...
          extraEnv = {
            ...
            FAVORITES_PG_COMPONENT_PSQL_CONNECTION_STRING = connBundleAuth "marketplace_squid";
          };
        };
      }
      // lib.optionalAttrs cfg.subServices.socialRpc {
