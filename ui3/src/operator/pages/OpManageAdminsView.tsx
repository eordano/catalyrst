                ...
                explicit.map((e) => (
                  <tr className="au-row" key={e.admin}>
                    ...
                    <td className="au-cell au-cell__addr">
                      {e.addedBy ? truncateAddress(e.addedBy) : "—"}
                    </td>
...
export default function OpManageAdminsView({
  ...
  const placeName = activePlace ? placeLabel(activePlace) : (activePlaceId ?? "—");
        ...
        {view === "confirm" && (
          <div className="sa-confirm">
            ...
            <p className="sa-confirm__sim">
              {action === "revoke"
                ? "Signs DELETE /scene-admin?place_id=…&admin=…"
        ...
        {view === "submitting" && (
          ...
          >
            ...
            <p className="sa-progress__label">
              {action === "revoke" ? "Revoking admin…" : "Granting admin…"}
            </p>
          </div>
        )}
