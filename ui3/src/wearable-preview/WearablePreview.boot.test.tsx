...
test("booted inits true when pauseOffscreen is falsy — boots on mount regardless of IntersectionObserver", async () => {
...
test("booted inits true when IntersectionObserver is undefined — boots on mount even with pauseOffscreen", async () => {
