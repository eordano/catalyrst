// GENERATED from src/data/auth/thirdwebSchema.ts by catalyrst/ui3/scripts/gen-schema-stubs.mts. Do not edit.
//
...
export const ThirdwebAuthResultSchema = accept;
export const EnclaveSignatureSchema = accept;
export const WalletsMeSchema = accept;
export const SignProxyOkSchema = accept;
