export const FEATURE_FLAGS = [
  ...
  { id: "2026-09-lobby", name: "Explorer lobby", description: "Open the avatar lobby with friends, events, place discovery and inline Backpack editing.", defaultEnabled: true },
  { id: "2026-09-sidebar-design", name: "Redesigned sidebar", description: "Use the new desktop navigation with grouped menus and quick access to Explorer panels.", defaultEnabled: true },
