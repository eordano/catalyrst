...
describe("when building explorer deep links", () => {
  it("should form-encode the realm URL and position, including path-addressed worlds composed lowercased and trimmed", () => {
    ...
    expect(
      realmDeepLink(
        worldRealmUrl("https://realm.example.org/worlds-content-server/", "swiss-cube"),
        "0,0",
      ),
    ).toBe(
