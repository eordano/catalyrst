// GENERATED from src/data/catalyst/schemas/places.ts by catalyrst/ui3/scripts/gen-schema-stubs.mts. Do not edit.
//
...
export const PlaceSchema = accept;
export const ListEnvelope = accept;
export const ItemEnvelope = accept;
export const CategorySchema = accept;
export const CategoriesEnvelope = accept;
