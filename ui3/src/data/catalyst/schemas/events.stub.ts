// GENERATED from src/data/catalyst/schemas/events.ts by catalyrst/ui3/scripts/gen-schema-stubs.mts. Do not edit.
//
...
export const EventSchema = accept;
export const EventCategorySchema = accept;
export const EventAttendeeSchema = accept;
