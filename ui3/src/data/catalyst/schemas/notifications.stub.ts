// GENERATED from src/data/catalyst/schemas/notifications.ts by catalyrst/ui3/scripts/gen-schema-stubs.mts. Do not edit.
//
...
export const NotificationSchema = accept;
export const ListEnvelopeSchema = accept;
