...
import { EventCategorySchema, EventSchema } from "./schemas/events";
import type { DclEventWire, EventCategoryWire } from "./schemas/events";

export { EventCategorySchema, EventSchema };
