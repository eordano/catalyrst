...
describe("localImageUrl", () => {
  it("proxies public marketing raster images through this deployment", () => {
    expect(localImageUrl("https://marketing-files.decentraland.org/uploads/banner.png")).toBe(`${window.location.origin}/marketing-files/uploads/banner.png`);
    for (const value of ["https://marketing-files.decentraland.org/uploads/banner.svg", "https://marketing-files.decentraland.org.evil.test/uploads/banner.png"]) expect(localImageUrl(value)).toBe(value);
  });
