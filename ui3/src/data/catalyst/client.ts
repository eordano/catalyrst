...
// each backend independently; the deployment default fronts them all on the
// catalyst host under the path prefixes its router exposes.
const SERVICE_DEFAULTS: Record<ServiceName, string> = {
  places: "https://catalyst.example.com/places",
  events: "https://catalyst.example.com/events",
  communities: "https://catalyst.example.com",
  communitiesCdn: "https://catalyst.example.com",
  notifications: "https://catalyst.example.com",
  badges: "https://catalyst.example.com",
  cameraReel: "https://catalyst.example.com/camera-reel",
  map: "https://catalyst.example.com",
  satellite: "https://catalyst.example.com/satellite",
};
...
export function serviceBase(service: ServiceName, override?: string): string {
  ...
  const fromWindow =
    typeof window !== "undefined"
      ...
      : undefined;
  const base = override ?? fromEnv ?? fromWindow ?? SERVICE_DEFAULTS[service];
  return base.replace(/\/$/, "");
}
