...
type CrewMember = { id: string; body: BodyId; skin: number; hair: number; eyes: number };

const CREW: readonly CrewMember[] = [
  { id: "c1", body: "A", skin: 0, hair: 2, eyes: 1 },
  { id: "c2", body: "B", skin: 2, hair: 0, eyes: 0 },
  { id: "c3", body: "A", skin: 4, hair: 5, eyes: 3 },
  { id: "c4", body: "B", skin: 1, hair: 3, eyes: 2 },
  { id: "c5", body: "A", skin: 3, hair: 1, eyes: 0 },
];
