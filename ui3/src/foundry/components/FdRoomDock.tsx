      ...
      {open ? (
        <div className="fd-room__chat">
          <ChatView
            ...
            emptyLine="Nothing said since you arrived \u{2014} room messages aren't recorded."
            io={io}
      ...
      <div className="fd-room__bar">
        {open ? (
          <button
            ...
            onClick={toggleMic}
            aria-pressed={micOn}
            title={micOn ? "Mute microphone" : "Talk \u{2014} unmute microphone"}
          >
            {micOn ? "mic on" : "mic"}
          </button>
        ) : null}
        ...
        >
          {others > 0
            ...
            : elsewhere > 0
              ? `just you \u{2014} ${elsewhere} elsewhere`
              : "just you"}
        </button>
      </div>
    </aside>
