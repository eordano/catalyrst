...
// These journey gaps stay fixed at the DOM: an ask's author gets an edit
// affordance and readers see the revision stamp; a session card carries its
// RSVP identifiers on the DOM (not only in the hydration payload) and its
...
describe("FdSessionsPage RSVP identifiers on the DOM", () => {
  ...
  it("names the RSVP and Withdraw buttons per session, straight quotes only", () => {
    ...
    expect(rsvp.getAttribute("aria-label")).not.toMatch(/\u{2019}/u);
  });
