              ...
              <Button
                ...
                title={
                  sessionGate
                    ...
                    : sessionGate === false
                      ? "your session holds no host or operator role \u{2014} redeem an invite on the People page first"
                      : undefined
                }
                onClick={() => onOpen?.()}
              >
      ...
      <FdSection title="The door, measured">
        ...
        {door ? (
          <dl className="fd-facts">
            ...
            <div>
              <dt>Stranded</dt>
              <dd title="door sessions that never got a reply \u{2014} the number this page exists to keep at zero">
