            ...
            <div className="fd-statrow">
              ...
              {probeMessages > 0 ? (
                <FdStat
                  ...
                  mono
                  note={`of those messages \u{B7} ${groupDigits(usage.probeTokens ?? 0)} tokens`}
                  title={`the session titled ${DEPLOY_PROBE_SESSION_TITLE} \u{2014} the deploy proving the gateway answers, not copilot drafting`}
                />
              ) : null}
            </div>
          </FdSection>
