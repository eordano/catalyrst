...
>) {
  ...
  const bodyError = overLimit
    ? `Keep the description under ${FD_BODY_MAX} characters \u{2014} it is ${body.length} now. Nothing was posted; your text is kept.`
    ...
    <form className="fd-form" method="post" onSubmit={submitPost}>
      ...
      <div className="fd-form__field">
        ...
        <input
          ...
          maxLength={60}
          autoComplete="off"
          placeholder="e.g. Discord #creators \u{2014} or leave blank: my own ask"
        />
        {formErrors?.source ? (
          <p className="fd-alert" role="alert">
            {formErrors.source}
