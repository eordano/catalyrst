    ...
    <div className="fd-page fd-stack fd-people">
      ...
      {canMint ? (
        <FdSection
          ...
          sub="A one-time code for someone you want here. Every mint is a recorded action \u{2014} who, role, note; never the code."
        >
          {minted ? (
          ...
          >
            ...
            <div className="fd-form__field">
              ...
              <input
                ...
                type="text"
                autoComplete="off"
                placeholder="who this is for \u{2014} lands in the ledger"
              />
            </div>
            <div className="fd-form__actions">
              <Button
