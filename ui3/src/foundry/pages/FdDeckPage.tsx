...
const CAPTURE = "archived capture, read Aug 16, 2026 \u{2014} source typos are preserved as captured";
...
const TOOLS: readonly { name: string; href?: string; label: string; note?: string }[] = [
  ...
  { name: "Community Import", label: "not built" },
  {
    ...
    label: "the calendar",
    note: "the calendar only \u{2014} nothing routes players to a session",
  },
];
...
export default function FdDeckPage() {
  return (
    <div className="fd-page fd-stack fd-deck">
      <FdPageHead
        title="The deck"
        intro="Scott McCarthy's \u{201C}Decentraland: From Thesis to Working Strategy\u{201D} \u{2014} advisor input, not adopted strategy."
        aside={
      ...
      <FdSection
        ...
        sub="T0 \u{2014} the first test wave \u{2014} is sized here."
      >
        <blockquote className="fd-deck__quote">
          <p>
