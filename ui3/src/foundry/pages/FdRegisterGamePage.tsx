    ...
    <div className="fd-page fd-stack">
      ...
      {!canHost ? (
        ...
        <FdSection
          ...
          sub="A registered game is a repo row: the shelf shows exactly what you enter here. Deployment facts \u{2014} world, size, dates \u{2014} are read only from the worlds mirror, so they stay empty until an import reads them."
        >
          {registeredSlug ? (
          ...
          <form className="fd-form fd-register" method="post" onSubmit={submit}>
            ...
            <div className="fd-form__field">
              ...
              <input
                ...
                type="text"
                autoComplete="off"
                placeholder="where this game comes from \u{2014} shown on its card"
                required
              />
            </div>
            <div className="fd-form__field">
