...
describe("rowStamp", () => {
  it("stamps a timed row in the one instant format, whatever its year", () => {
    expect(rowStamp("2026-08-15T14:03:00.000Z")).toBe("Aug 15, 2026 \u{B7} 14:03 UTC");
    expect(rowStamp("2021-03-16T14:03:00.000Z")).toBe("Mar 16, 2021 \u{B7} 14:03 UTC");
  });

  it("stamps a date-only row as the day alone \u{2014} no invented midnight", () => {
