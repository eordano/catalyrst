...
export default function FdPersonaPage({
  ...
  return (
    <div className="fd-page fd-stack fd-persona">
      <FdPageHead
        title="Your persona"
        intro="A name and an avatar, kept to this browser's session cookie \u{2014} no wallet, no email, no account. A return code brings it back in any browser."
      />
            ...
            <div className="fd-persona__controls">
              <div className="fd-form__field">
                ...
                <input
                  ...
                  title="2\u{2013}32 characters. Letters, numbers, spaces and . _ - only."
                  required
                  autoComplete="off"
                />
                <p className="fd-note">
              ...
              <div className="fd-form__field">
                ...
                <textarea
                  ...
                  maxLength={280}
                  rows={3}
                  placeholder="Who you are here \u{2014} optional, shown on People."
                />
              </div>
          ...
          {showCode ? (
            <div className="fd-persona__carry" role="status">
              ...
              <p className="fd-note">
                ...
                <strong>{personaName}</strong> again \u{2014} role, acts, and all.
            ...
            <div className="fd-persona__carry">
              <p className="fd-note">
                This persona has no return code yet. Mint one now \u{2014} shown once
                \u{2014} so a cleared cookie can't take <strong>{personaName}</strong>{" "}
