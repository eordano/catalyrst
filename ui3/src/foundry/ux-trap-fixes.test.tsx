...
// These persona-journey UX traps stay fixed: the ask form's limit is visible
// while typing and unmissable on failure, the write cap names its wait, the
// readings page says what it is and where a player responds, the continuity
// bundle is readable without a forced download, and the shell nav collapses
...
describe("FdExchangePage ask form limit", () => {
  ...
  it("the write-cap message renders beside the submit button too", () => {
    const message =
      "Too many writes from this session \u{2014} wait a minute, then post again. Your draft is still in the form.";
    const { container } = render(
