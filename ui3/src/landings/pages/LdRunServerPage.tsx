...
const SHAPES = [
  {
    ...
    detail:
      "Content server, sync and postgres behind a plain LAN edge. No public exposure required — a homelab box or the smallest VPS tier works.",
    sizing: "2 vCPU · 8 GB RAM to start — lower the sync memory caps on small boxes.",
  },
  {
    name: "Full realm",
    ...
    sizing: "4 vCPU · 16 GB RAM — the shipped memory caps assume this class.",
  },
  {
    name: "Public gateway",
    ...
    sizing:
      "4–8 vCPU · 16 GB RAM, plus archive-capable Ethereum and Polygon RPC endpoints for the indexer.",
  },
];
...
const STEPS = [
  {
    ...
    body: "Any provider whose VMs give you root works — use their NixOS image, or nixos-anywhere onto a rescue system. Two lessons a real install teaches: import the qemu-guest profile so the initrd has virtio drivers, and install a bootloader that covers both BIOS and UEFI — newer VPS generations boot UEFI and silently wedge without it.",
  },
  {
    title: "Answer the setup wizard",
    body: "It generates your host configuration and the secrets files services refuse to start without. It runs entirely in your browser — you can answer it before the server even exists.",
  },
  {
    title: "Point DNS at the machine",
    body: "Your domain, and — for a public shape — every certificate name the wizard lists, all resolving to the VPS address before first boot. Certificates issue themselves over HTTP-01 once they do.",
  },
  {
    title: "Boot it",
    ...
    <main className="ldrun">
      ...
      <section className="ldrun-section">
        ...
        <p className="ldrun-note">
          ...
          running the software — your node serves its realm either way.
        </p>
      </section>
