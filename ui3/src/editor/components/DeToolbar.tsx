      ...
      {!live && (
        <div ref={menuRef} style={{ position: "relative", display: "flex" }}>
          ...
          {open && (
            <div className="eui-menu">
              <div className="eui-menu-label">Camera</div>
              <button className="eui-menu-item">Player camera<span className="hint">{camMode === "none" ? "\u{25CF}" : ""}</span></button>
              <button className="eui-menu-item">Free fly<span className="hint">{camMode === "free" ? "\u{25CF}" : ""}</span></button>
              <button className="eui-menu-item">Orbit selection<span className="hint">{camMode === "target" ? "\u{25CF}" : ""}</span></button>
              {camMode !== "none" && (
