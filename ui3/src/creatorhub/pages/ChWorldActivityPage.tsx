    ...
    return (
      <div className="wa">
        ...
        <EmptyState
          ...
          subtitle={`${world} is not on worlds-content-server and catalyst.example.com has no /world/${world}/about for it.`}
          ...
          <DatumTile
            ...
            note={
              showable(inThisWorld) && inThisWorld.value === 0
                ? "a real zero — nobody in it at the last snapshot"
                : undefined
            }
          />
          <DatumTile
            ...
            note={
              showable(commsRoom) && commsRoom.value === 0
                ? "a real zero — the worlds server reports an empty room"
                : undefined
            }
          />
      ...
      <section className="wa__section" aria-labelledby="wa-history">
        ...
        {!showable(history) ? (
          <EmptyState
            ...
            actions={
              onRetryHistory
                ? [{ label: "⟳ Try again", onClick: onRetryHistory }]
                : undefined
            }
            icon={undefined}
            variant={undefined}
          ...
          <EmptyState
            ...
            subtitle={`The presence collector has no snapshots for ${world} — that means it has not been in the poll set, not that it had no visitors.`}
            actions={
              jumpUrl
                ? [
                    {
