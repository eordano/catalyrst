    ...
    <div className="ai">
          ...
          <DatumTile
            ...
            note={
              showable(peopleInYourWorlds) && peopleInYourWorlds.value === 0
                ? "a real zero — the worlds server reports nobody in any of your worlds"
                : undefined
            }
          />
          <DatumTile
      ...
      <section className="ai__section" aria-labelledby="ai-genesis">
        ...
        <UnbuiltPanel
          ...
          today="a parcel cannot be listed, only looked up — the field below reads the same occupancy history for any coordinate."
        />
          ...
          <div className="ai__parcel">
            ...
            {parcel.noHistory ? (
              <EmptyState
                ...
                subtitle="The presence collector has no snapshots for this pointer — that means it has not been in the poll set, not that it had no visitors."
                actions={
                  parcel.jumpUrl
                    ? [
                        {
