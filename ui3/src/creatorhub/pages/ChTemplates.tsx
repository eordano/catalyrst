    ...
    <div className="chtpl__backdrop" onClick={onClose}>
      ...
      >
        ...
        <div className="chtpl__modalbody">
          ...
          <p className="chtpl__desc">
            {value.template
              ? "The editor opens with this template's scene content already placed — press Play there to run its starter game, rename the scene any time and use Save to keep it in your library."
              : "The editor opens on an empty scene — use Save to keep it in your library."}
          </p>
        </div>
...
const TEMPLATES: ChTemplate[] = [
  {
    id: "nft-art-wall",
    title: "Art Wall",
    description: "A curated gallery layout — white walls, pillars and three placeholder canvases — plus a small SDK7 starter script that cycles each canvas and shows how to swap one for a real NFT frame. Press Play in the editor to run it.",
    tags: ["Showcase"],
  ...
  },
  {
    id: "castaway-2048",
    title: "Castaway 2048",
    description: "A beach-scene starter with a 2048-style board and four tiles, plus a small SDK7 starter script that labels tiles and doubles their value on click — a seed for building the full sliding puzzle — press Play in the editor to run it (original SDK6 scene linked below).",
    tags: ["Game", "Puzzle"],
  ...
  },
  {
    id: "escape-room",
    title: "Escape Room",
    description: "An escape-room starter layout — locked door, lever, hidden key and candle-lit props — with a small SDK7 script wiring the find-the-key, pull-the-lever, open-the-door sequence — press Play in the editor to run it (not the original 9-room game, which is linked below).",
    tags: ["Game", "Puzzle"],
  ...
  },
  {
    id: "memory-game",
    title: "Memory Game",
    description: "An arcade starter with four Simon-style colour pads and a small SDK7 script that flashes a growing sequence and checks your clicks — a compact example of click events and game state. Press Play in the editor to run it.",
    tags: ["Game"],
    difficulty_level: "Easy",
  ...
  },
  {
    id: "tower-defense",
    title: "Tower Defense",
    description: "A tower-defense starter layout — cobbled path, spawn gate, watch posts and creep spiders — with a small SDK7 script that marches the creeps down the path and lets you click to repel them — press Play in the editor to run it (not the full original game, which is linked below).",
    tags: ["Game"],
    difficulty_level: "Hard",
