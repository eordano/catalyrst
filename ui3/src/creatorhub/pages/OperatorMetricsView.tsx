...
function MetricsBadge({ source }: MetricsBadgeProps) {
  ...
  return (
    <span className="op-sample" title="This hub isn’t connected to a telemetry store">
      Not connected
    </span>
  );
}
              ...
              <section className="op-card" aria-label="Deploy funnel">
                ...
                <p className="op-note">
                  {funnel.source === "live"
                    ...
                    : "This hub isn’t connected to a telemetry store yet, so counts show 0. Connect it to the catalyst-telemetry store to surface the live deploy funnel."}
                </p>
              </section>
              ...
              <section className="op-card" aria-label="Moderation activity">
                ...
                <p className="op-note">
                  {admin.source === "live"
                    ...
                    : "This hub isn’t connected to a telemetry store yet, so counts show 0. Connect it to the catalyst-telemetry store to surface live moderation activity."}
                </p>
              </section>
            </div>
          </details>
