...
const CASES: { label: string; args: Partial<AnalyticsStoryArgs> }[] = [
  ...
  { label: "Drilldown · Genesis parcel", args: { selection: "genesisParcel" } },
  { label: "Drilldown · World", args: { selection: "world" } },
  {
    label: "Drilldown · honest-empty World",
    args: { dataset: "honestEmpty", selection: "honestEmptyWorld" },
  },
  { label: "Drilldown · no data for scene", args: { selection: "missingWorld" } },
