...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "The endpoint line plus the reason sentence. Mandatory beneath any tile in a `no-sample`, `unavailable` or `unbuilt` state — the reason a value is missing is not optional chrome. Every sentence is derived from the datum, so the copy cannot drift between screens.",
      },
    },
  },
  argTypes: {
