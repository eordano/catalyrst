...
const CASES: { label: string; args: Partial<WpProps> }[] = [
  { label: "Access · invitation only", args: { accessType: "allowList" } },
  { label: "Access · public", args: { accessType: "unrestricted" } },
  { label: "Access · password protected", args: { accessType: "sharedSecret" } },
  { label: "Invite · wallet", args: { view: "invite_form", inviteTab: "wallet" } },
  { label: "Invite · community", args: { view: "invite_form", inviteTab: "community" } },
  { label: "Invite · CSV", args: { view: "invite_form", inviteTab: "csv" } },
  ...
  { label: "Collaborators · empty", args: { tab: "collaborators", view: "empty" } },
  { label: "Collaborators · add", args: { tab: "collaborators", view: "add" } },
  { label: "Collaborators · clear confirm", args: { tab: "collaborators", view: "clear_confirmation" } },
  { label: "Collaborators · parcels", args: { tab: "collaborators", view: "parcels" } },
