...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Every datum the hub can show, its endpoint, its probed state, and what reads it — including the endpoints deliberately *not* displayed, with the reason. `live` and `sampled` rows carry a probe result; `unbuilt` and `excluded` rows are constants and are never probed.",
      },
    },
  },
  argTypes: {
