...
const TODAY = {
  ...
  cli: (
    <CliEscape
      ...
      explain="dcl-scene-bots is an MCP client you run beside your own explorer. It catches TypeError · ReferenceError · Cannot read · is not a function · unhandled promise rejection."
    />
  ),
};
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "A capability with no backend. Renders `<section role=\"note\">` and has **no click surface** — no button, no disabled control, no form, no link that could return a fake success. A disabled button teaches “this will work once I'm signed in”; a dashed note naming the missing service teaches the truth.",
      },
    },
  },
  argTypes: {
