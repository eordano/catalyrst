...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "The only thing in the tree that renders a state word. Glyph plus word, always — colour never carries the meaning alone, so the state survives greyscale and a screen reader hears the word.",
      },
    },
  },
  argTypes: {
