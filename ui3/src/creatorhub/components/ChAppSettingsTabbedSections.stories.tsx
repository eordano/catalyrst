...
const CASES: { label: string; args: Partial<AsProps> }[] = [
  ...
  { label: "About tab · idle", args: { initialTab: "about", updateState: "idle" } },
  { label: "About tab · up to date", args: { initialTab: "about", updateState: "up_to_date" } },
  {
    label: "About tab · downloading",
    args: { initialTab: "about", updateState: "downloading", progress: 42 },
  },
  {
    label: "Scenes tab · invalid folder",
    args: { initialTab: "scenes", initialError: INVALID_PATH_ERROR },
  },
  {
    label: "About tab · update available",
    args: { initialTab: "about", updateState: "available", releaseNotes: null },
  },
  { label: "About tab · downloaded (with release notes)", args: { initialTab: "about", updateState: "downloaded" } },
];
