...
const CASES: { label: string; args: Partial<Props> }[] = [
  { label: "1 · Review collection", args: { step: "summary", view: "summary" } },
  { label: "2 · Publish fee", args: { step: "cost", view: "cost" } },
  { label: "3 · Terms", args: { step: "terms", view: "terms" } },
  { label: "4 · Paying", args: { step: "pay", view: "pay" } },
  { label: "5 · Submitted", args: { step: "submitted", view: "submitted" } },
  { label: "Error", args: { step: "error", view: "error" } },
  {
    label: "Blocked · empty draft",
    args: {
      step: "blocked",
      view: "blocked",
      summary: null,
