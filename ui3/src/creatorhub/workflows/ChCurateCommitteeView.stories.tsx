...
const APPROVE_COMMENT = "Great silhouette work and clean topology — approving.";
const REJECT_COMMENT =
  "The feet mesh clips through the ankle bone in the walk cycle — please fix and resubmit.";
...
const CASES: { label: string; args: Partial<CurateProps> }[] = [
  ...
  {
    label: "Commenting · approving",
    args: { view: "commenting", step: "comment", decision: "approved" },
  },
  {
    label: "Commenting · rejecting",
    args: {
      view: "commenting",
      step: "comment",
      decision: "rejected",
