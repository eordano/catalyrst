...
export default function FeatureFlags() {
  ...
  return <section className="ff" aria-labelledby="feature-flags-title">
    ...
    <footer className="ff__apply"><span role="status">{pending ? "Changes saved. Reload to apply them." : "Your feature flags are up to date."}</span><Button disabled={!pending} onClick={() => window.location.reload()}>Reload Explorer</Button></footer>
  </section>;
}
