...
export const BridgeActionSchema = z.enum(["Teleport", "ChangeRealm", "SendChat", "friends.request", "SignRequest", "PlayEmote", "StopEmote", "SetTimeOfDay", "SetSetting", "SetMic", "SetMicEnabled", "SetAvatar", "SetIdentity", "LoginGuest", "LoginNew", "Logout", "SignedFetch", "RequestAvatarPreview", "RotateAvatarPreview", "ResolvePermission", "CapturePhoto", "SetCameraMode"]);
