// GENERATED from src/generated/editor-bus-schemas.ts by catalyrst/ui3/scripts/gen-schema-stubs.mts. Do not edit.
//
...
export const CameraModeSchema = accept;
export const CameraPresetSchema = accept;
export const CameraSensitivitySchema = accept;
export const EditorToolSchema = accept;
export const NodeDisplaySchema = accept;
export const OrthoRequestSchema = accept;
export const RpcIdSchema = accept;
export const PageToSceneMessageSchema = accept;
export const EditorEntityNodeSchema = accept;
export const ParcelCoordSchema = accept;
export const LiveSceneInfoSchema = accept;
export const SceneToPageMessageSchema = accept;
export const BusEnvelopeSchema = accept;
