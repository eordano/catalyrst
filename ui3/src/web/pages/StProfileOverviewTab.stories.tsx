...
const meta = {
  ...
  argTypes: {
    profilePreset: {
      ...
      description:
        "Which profile fixture is rendered — badges/bio/info/links/equipped filled, or all empty.",
    },
    isOwnProfile: {
      control: "boolean",
...
const CATALOG: { label: string; args: OverviewStoryArgs }[] = [
  ...
  { label: "empty — member", args: { profilePreset: "emptyTeal", isOwnProfile: false, loading: false } },
  { label: "empty — owner", args: { profilePreset: "emptyAmber", isOwnProfile: true, loading: false } },
