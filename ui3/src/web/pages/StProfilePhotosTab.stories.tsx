...
const meta = {
  ...
  argTypes: {
    photoSet: {
      control: "select",
      options: ["twelve", "none"],
      description: "Which photo fixture is passed — the twelve-shot reel, or an empty list.",
    },
    isOwnProfile: {
      control: "boolean",
...
const CATALOG: { label: string; args: PhotosStoryArgs }[] = [
  ...
  { label: "empty — owner", args: { photoSet: "none", isOwnProfile: true } },
  { label: "empty — member", args: { photoSet: "none", isOwnProfile: false } },
];
