...
const meta = {
  ...
  argTypes: {
    communitySet: {
      ...
      options: ["eight", "none"],
      description:
        "Which community fixture is passed — the eight-card set (owner/admin/member roles), or an empty list.",
    },
    isOwnProfile: {
      control: "boolean",
...
const CATALOG: { label: string; args: CommunitiesStoryArgs }[] = [
  ...
  { label: "empty — owner", args: { communitySet: "none", isOwnProfile: true, loading: false } },
  { label: "empty — member", args: { communitySet: "none", isOwnProfile: false, loading: false } },
