...
const CATALOG: { label: string; props: ProfileTabLayoutProps }[] = [
  {
    label: "overview — split with aside",
    props: {
      profile: PROFILES.claimed,
      tabs: TABS.member,
      activeTab: "overview",
  ...
  {
    label: "full width — owner asset grid",
    props: {
      profile: PROFILES.claimed,
      tabs: TABS.own,
      activeTab: "assets",
  ...
  {
    label: "unclaimed name — #abcd discriminator",
    props: {
  ...
  {
    label: "assets header — no wallet icon, no copy",
    props: {
      profile: PROFILES.claimed,
      tabs: TABS.own,
      activeTab: "assets",
  ...
  {
    label: "no nameColor — hue derived from the name",
    props: {
