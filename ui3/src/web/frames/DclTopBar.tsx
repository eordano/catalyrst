...
const LEARN_MENU: NavMenuItem[] = [
  // Absolute: the docs site is not proxied on every sub-origin (foundry.catalyst.example.com
  // /docs/ 404s), and docs.decentraland.org is the canonical home anyway.
